...
internal readonly struct OVRSEnumerable<T> : IEnumerable<T>
{
    private readonly IEnumerable<T> _enumerable;

    /// <summary>This is an internal member.</summary>
    public OVRSEnumerable(IEnumerable<T> enumerable) => _enumerable = enumerable;
...
static partial class OVRSExtensions
{
    /// <summary>
    ...
    internal static OVRSEnumerable<T> ToNonAlloc<T>([NoEnumeration] this IEnumerable<T> enumerable) => new(enumerable);
...
internal static class OVRSEnumerable
{
    /// <summary>This is an internal member.</summary>
    public static unsafe int CopyTo<T>(this OVRSEnumerable<T> enumerable, T* memory) where T : unmanaged
    {
        var count = 0;
        foreach (var item in enumerable)
        {
