...
public class OVRSAnchor : MonoBehaviour
{
    ...
    public enum SaveResult
    {
        ...
        /// </summary>
        /// <remarks>
        /// An <see cref="OVRSAnchor"/> is invalid if it is default constructed,
  ...
  /*  [OVRResultStatus]*/
    ...
    /// </summary>
    /// <remarks>
    /// Use <see cref="OVRSAnchor.FetchAnchorsAsync(System.Collections.Generic.List{OVRSAnchor},OVRSAnchor.FetchOptions,System.Action{System.Collections.Generic.List{OVRSAnchor},int})"/>
   ...
   /* public enum ShareResult
    {
        ...
        /// </summary>
        /// <remarks>
        /// This usually refers to anchor handles. An <see cref="OVRSAnchor"/> is invalid if it is default constructed,
        /// which is often the case before an <see cref="OVRSpatialAnchor"/> gets properly bound, or before it has
        /// a chance to invoke its <c>Start()</c> method.
        /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Because <see cref="OVRSAnchor"/> is a value-type, it is not C#-nullable. However, if you default-construct an
    /// <see cref="OVRSAnchor"/> (instead of obtaining one from a query or creation method) then it will be equal to
    ...
    internal static void OnSpaceDiscoveryResultsAvailable(OVRDeserialize.SpaceDiscoveryResultsData data)
    {
        ...
        using (results)
        {
            ...
            {
                var item = results[i];
                taskData.Anchors.Add(new OVRSAnchor(item.Space, item.Uuid));
            }
        }
    ...
    {
        public List<OVRSAnchor> Anchors;
        public Action<List<OVRSAnchor>, int> IncrementalResultsCallback;
    }
    /// \endcond
    ...
    /// <seealso cref="ShareAsync(IEnumerable{OVRSAnchor},Guid)"/>
    /// </param>
    /// <param name="anchors">
    ...
    public T GetComponent<T>() where T : struct, IOVRSAnchorComponent<T>
    {
    ...
    public bool Equals(OVRSAnchor other) => Handle.Equals(other.Handle) && Uuid.Equals(other.Uuid);

    /// <summary>
    /// Compares this anchor with an object for equality.
    /// </summary>
    /// <param name="obj">The `object` to compare with this anchor.</param>
    /// <returns>Returns `true` if <paramref name="obj"/> is an <see cref="OVRSAnchor"/> and
    /// <see cref="Equals(OVRSAnchor)"/> is also `true`, otherwise `false`.</returns>
    public override bool Equals(object obj) => obj is OVRSAnchor other && Equals(other);

    /// <summary>
    /// Compares two anchors for equality.
    /// </summary>
    /// <remarks>
    /// This is the same equality test as <see cref="Equals(OVRSAnchor)"/>.
    /// </remarks>
    ...
    public static bool operator ==(OVRSAnchor lhs, OVRSAnchor rhs) => lhs.Equals(rhs);

    /// <summary>
    /// Compares two anchors for inequality.
    /// </summary>
    /// <remarks>
    /// This is the logical negation of <see cref="Equals(OVRSAnchor)"/>.
    /// </remarks>
    /// <param name="lhs">The anchor to compare with <paramref name="rhs"/>.</param>
    /// <param name="rhs">The anchor to compare with <paramref name="lhs"/>.</param>
