...
namespace MetaAvatarsVR.Networking
{
    ...
    public class FlashlightButton : MonoBehaviour
    {
        ...
        private void SetupInteractable()
        {
            ...
            Debug.Log($"[FlashlightButton] {name} - PokeInteractable configured");
        }

        private void HandlePointerEvent(PointerEvent evt)
        {
            Debug.Log($"[FlashlightButton] {name} - Pointer Event: {evt.Type}");
        ...
        private void OnHoverEnter()
        {
            ...
            Debug.Log($"[FlashlightButton] {name} - Hover Enter");
        }
        ...
        private void OnHoverExit()
        {
            ...
            Debug.Log($"[FlashlightButton] {name} - Hover Exit");
        }
        ...
        private void OnPokeStart()
        {
            ...
            Debug.Log($"[FlashlightButton] {name} - Button Pressed!");
        }
        ...
        private void OnPokeEnd()
        {
            ...
            Debug.Log($"[FlashlightButton] {name} - Button Released!");
        }
        #endregion
        ...
        private void TriggerHapticsOVR(object interactor)
        {
            ...
            {
                Debug.LogWarning($"[FlashlightButton] Could not trigger OVR haptics: {e.Message}");
            }
        }
        ...
        private void ValidateComponents()
        {
            if (pokeInteractable == null)
            {
                Debug.LogError($"[FlashlightButton] {name} - PokeInteractable component required!");
            }
