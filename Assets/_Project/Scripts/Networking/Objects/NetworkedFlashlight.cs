...
namespace MetaAvatarsVR.Networking
{
    ...
    public class NetworkedFlashlight : NetworkBehaviour
    {
        ...
        {
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Spawned. HasAuthority: {HasStateAuthority}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            AdvancedDebugSystem.Log($"  NetworkedSpotLight found: {networkedSpotLight != null}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            if (spotLight != null)
            {
                AdvancedDebugSystem.Log($"  SpotLight renderingLayerMask: {spotLight.renderingLayerMask}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
                AdvancedDebugSystem.Log($"  Normal Layer: {normalRenderingLayer}, UV Layer: {uvRenderingLayer}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            }
        ...
        public override void FixedUpdateNetwork()
        {
            ...
            {
                AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Mode: {CurrentMode}, Active: {IsActive}, Holder: {CurrentHolder}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            }
        }
        ...
        private void OnGrabbed(PlayerRef grabber)
        {
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Grabbed by {grabber}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        private void OnReleased()
        {
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Released", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        {
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Button pressed locally. HasAuthority: {HasStateAuthority}, IsActive: {IsActive}, CurrentHolder: {CurrentHolder}, LocalPlayer: {Runner.LocalPlayer}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        {
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - RPC Mode change requested from client", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        private void ToggleFlashlightMode()
        {
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Toggling mode from {CurrentMode}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] Mode changed to: {newMode}, RenderingLayer: {newRenderingLayer}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        {
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Mode changed to {newMode} (notified via RPC)", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        {
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Mode changed to: {CurrentMode}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        {
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Active state changed to: {IsActive}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        {
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Rendering layer changed to: {CurrentRenderingLayer} (Expected for mode: {CurrentMode})", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            ...
            if (spotLight != null)
            {
                ...
                AdvancedDebugSystem.Log($"[NetworkedFlashlight] Applied renderingLayerMask: {layerMask} (Binary: {System.Convert.ToString(layerMask, 2)})", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        private void UpdateFlashlightState()
        {
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] UpdateFlashlightState - Mode: {CurrentMode}, Active: {IsActive}, CurrentRenderingLayer: {CurrentRenderingLayer}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        ...
        private void ApplyWhiteLightSettings()
        {
            ...
            if (networkedSpotLight != null && HasStateAuthority)
            {
                ...
                AdvancedDebugSystem.Log($"[NetworkedFlashlight] Updating NetworkedSpotLight - Layer: {CurrentRenderingLayer}, Mask: {networkLayerMask}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            }
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Applied white light settings.", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            AdvancedDebugSystem.Log($"  CurrentRenderingLayer: {CurrentRenderingLayer}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            AdvancedDebugSystem.Log($"  RenderLayer Mask: {spotLight.renderingLayerMask} (Binary: {System.Convert.ToString((long)spotLight.renderingLayerMask, 2)})", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        }
        ...
        private void ApplyUVLightSettings()
        {
            ...
            if (networkedSpotLight != null && HasStateAuthority)
            {
                ...
                AdvancedDebugSystem.Log($"[NetworkedFlashlight] Updating NetworkedSpotLight UV - Layer: {CurrentRenderingLayer}, Mask: {networkLayerMask}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            }
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Applied UV light settings.", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            AdvancedDebugSystem.Log($"  CurrentRenderingLayer: {CurrentRenderingLayer}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            AdvancedDebugSystem.Log($"  RenderLayer Mask: {spotLight.renderingLayerMask} (Binary: {System.Convert.ToString((long)spotLight.renderingLayerMask, 2)})", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        }
            ...
            if (spotLight != null)
            {
                ...
                if (!enabled)
                {
                    ...
                    if (networkedSpotLight != null && HasStateAuthority)
                    {
                        ...
                        AdvancedDebugSystem.Log($"[NetworkedFlashlight] NetworkedSpotLight disabled - Layer: {CurrentRenderingLayer}, Mask: {currentMask}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
                    }
        ...
        private void OnModeTransition(FlashlightMode from, FlashlightMode to)
        {
            ...
            AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Transition from {from} to {to}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
        }
        #endregion
        ...
        private void InitializeLights()
        {
            if (spotLight != null)
            {
                ...
                AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Light initialized", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            }
        }
        #endregion
        ...
        private void ValidateComponents()
        {
            if (spotLight == null)
            {
                ...
                if (spotLight == null)
                {
                    AdvancedDebugSystem.LogError($"[NetworkedFlashlight] {name} - No Light component found!", LogCategory.Flashlight | LogCategory.Photon);
                }
                else
                {
                    AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - Light found. Current renderingLayerMask: {spotLight.renderingLayerMask}", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
                }
            }
            ...
            {
                AdvancedDebugSystem.LogError($"[NetworkedFlashlight] {name} - NetworkObject component required!", LogCategory.Flashlight | LogCategory.Photon);
            }

            if (grabbable == null)
            {
                AdvancedDebugSystem.LogError($"[NetworkedFlashlight] {name} - FusionVRGrabbable component required!", LogCategory.Flashlight | LogCategory.Photon);
            }

            // Información sobre NetworkedSpotLight
            if (networkedSpotLight != null)
            {
                AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - NetworkedSpotLight component found and will be synchronized", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            }
            else
            {
                AdvancedDebugSystem.Log($"[NetworkedFlashlight] {name} - No NetworkedSpotLight component found. Light will be updated locally only.", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
                AdvancedDebugSystem.Log($"  To enable networked light sync, add NetworkedSpotLight component to the light GameObject", LogCategory.Flashlight | LogCategory.Photon, LogLevel.Debug);
            }
        }
        #endregion
