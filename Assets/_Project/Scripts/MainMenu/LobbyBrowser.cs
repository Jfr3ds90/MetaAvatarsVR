...
namespace HackMonkeys.UI.Panels
{
    ...
    public class LobbyBrowser : MenuPanel
    {
        ...
        private GameObject selectedRoomInfo;
        ...
        [Header("Filters")] [SerializeField] private Toggle showFullRoomsToggle;
        [SerializeField] private Toggle showInProgressToggle;
        [SerializeField] private TMP_Dropdown sortDropdown;

        [Header("Visual Settings")] [SerializeField]
        private float roomItemSpacing = 0.15f;

        [SerializeField] private int maxVisibleRooms = 6;
        [SerializeField] private ScrollRect scrollView;

        [Header("Color Theme")] [SerializeField]
        private UIColorTheme colorTheme;
        ...
        private void OnRoomSelected(SessionInfo session)
        {
            ...
            if (selectedRoomStatus != null)
            {
                ...
                selectedRoomStatus.color =
                    colorTheme.GetRoomStateColor(session.IsOpen, session.PlayerCount >= session.MaxPlayers);
            }
