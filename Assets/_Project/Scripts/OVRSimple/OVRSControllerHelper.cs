...
public class OVRSControllerHelper : MonoBehaviour,
    OVRInputModule.InputSource
{
    ...
    /// OVRSControllerHelper queries <see cref="OVRInput"/> and the underlying system for the appropriate
    ...
    void InitializeControllerModels()
    {
        ...
        OVRSimple.InputFocusAcquired += InputFocusAquired;
        OVRSimple.InputFocusLost += InputFocusLost;
    ...
    /// <summary>
    /// Checks whether or not this OVRSControllerHelper instance has been Destroyed; a convenience wrapper
