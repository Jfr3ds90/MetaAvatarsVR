...
/// </summary>
internal static class OVRSSpaceQuery
{
    ...
    internal static SpaceQueryInfo2 ForAnchorsUnchecked(OVRSEnumerable<Guid> anchorIds)
    {
    ...
    internal static SpaceQueryInfo2 ForGroupUnchecked(Guid groupUuid, OVRSEnumerable<Guid> anchorIds = default)
    {
        var query = s_TemplateQuery;
        query.FilterType = SpaceQueryFilterType.Group;
        query.MaxQuerySpaces = MaxResultsForGroup;
    ...
    /// <summary>
    /// (Obsolete)(Internal) Represents options used to generate an <see cref="OVRSSpaceQuery"/>.
    /// </summary>
