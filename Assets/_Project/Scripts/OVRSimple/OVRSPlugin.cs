...
#define OVRSPLUGIN_UNSUPPORTED_PLATFORM
#endif

#if !(UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN || UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX || (UNITY_ANDROID && !UNITY_EDITOR))
#define OVRSPLUGIN_QPL_UNSUPPORTED_PLATFORM
#endif


#if UNITY_ANDROID && !UNITY_EDITOR
#define OVRSPLUGIN_INCLUDE_MRC_ANDROID
#endif
...
// Internal C# wrapper for OVRSPlugin.

public static partial class OVRSPlugin
{
#if OVRSPLUGIN_UNSUPPORTED_PLATFORM && OVRSPLUGIN_QPL_UNSUPPORTED_PLATFORM
...
#else
    public static readonly System.Version wrapperVersion = OVRSP_1_106_0.version;
#endif
    ...
    public static System.Version version
    {
        get
        {
#if OVRSPLUGIN_EDITOR_MOCK_ENABLED
            return wrapperVersion;
#elif OVRSPLUGIN_UNSUPPORTED_PLATFORM && OVRSPLUGIN_QPL_UNSUPPORTED_PLATFORM
            Debug.LogWarning("Platform is not currently supported by OVRSPlugin");
            return _versionZero;
#else
            if (_version == null)
            {
                try
                {
                    string pluginVersion = OVRSP_1_1_0.ovrp_GetVersion();
                ...
                // Unity 5.1.1f3-p3 have OVRSPlugin version "0.5.0", which isn't accurate.
                if (_version == OVRSP_0_5_0.version)
                    _version = OVRSP_0_1_0.version;

                if (_version > _versionZero && _version < OVRSP_1_3_0.version)
                    throw new PlatformNotSupportedException(
                        "Oculus Utilities version " + wrapperVersion + " is too new for OVRSPlugin version " +
        ...
        get
        {
            ...
            if (_nativeSDKVersion == null)
            {
                try
                {
                    ...
                    if (version >= OVRSP_1_1_0.version)
                        sdkVersion = OVRSP_1_1_0.ovrp_GetNativeSDKVersion();
                    else
    ...
    {
#if OVRSPLUGIN_UNSUPPORTED_PLATFORM
        // do nothing
#else
        if (version >= OVRSP_1_70_0.version)
        {
            Result result = OVRSP_1_70_0.ovrp_SetLogCallback2(logCallback);
            if (result != Result.Success)
            {
                Debug.LogWarning("OVRSPlugin.SetLogCallback2() failed");
            }
        }
#endif
    }
...
#pragma warning restore CS0618
    ...
    {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = OVRSP_1_68_0.OVRSP_RENDER_MODEL_MAX_NAME_LENGTH)]
    ...
    public static bool initialized
    {
        get
        {
            ...
            return false;
#else
            return OVRSP_1_1_0.ovrp_GetInitialized() == OVRSPlugin.Bool.True;
#endif
        }
    }
    ...
    public static XrApi nativeXrApi
    {
        get
        {
            ...
            if (!_nativeXrApi.HasValue)
            {
                ...
                if (version >= OVRSP_1_55_0.version)
                {
                    XrApi xrApi;
                    if (OVRSP_1_55_0.ovrp_GetNativeXrApiType(out xrApi) == Result.Success)
                    {
                        _nativeXrApi = xrApi;
                    }
                }
    ...
    public static bool chromatic
    {
        get
        {
            ...
            return false;
#else
            if (version >= OVRSP_1_7_0.version)
                return initialized && OVRSP_1_7_0.ovrp_GetAppChromaticCorrection() == OVRSPlugin.Bool.True;
        ...
        set
        {
            ...
            return;
#else
            if (initialized && version >= OVRSP_1_7_0.version)
                OVRSP_1_7_0.ovrp_SetAppChromaticCorrection(ToBool(value));
#endif
        }
    }
    ...
    public static bool monoscopic
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetAppMonoscopic() == OVRSPlugin.Bool.True;
#endif
        }
        set
        {
            ...
            if (initialized)
            {
                OVRSP_1_1_0.ovrp_SetAppMonoscopic(ToBool(value));
            }
#endif
        }
    }
    ...
    public static bool rotation
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetTrackingOrientationEnabled() == Bool.True;
#endif
        }
        set
        {
            ...
            if (initialized)
            {
                OVRSP_1_1_0.ovrp_SetTrackingOrientationEnabled(ToBool(value));
            }
#endif
        }
    }
    ...
    public static bool position
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetTrackingPositionEnabled() == Bool.True;
#endif
        }
        set
        {
            ...
            if (initialized)
            {
                OVRSP_1_1_0.ovrp_SetTrackingPositionEnabled(ToBool(value));
            }
#endif
        }
    }
    ...
    public static bool useIPDInPositionTracking
    {
        get
        {
            ...
            return false;
#else
            if (initialized && version >= OVRSP_1_6_0.version)
                return OVRSP_1_6_0.ovrp_GetTrackingIPDEnabled() == OVRSPlugin.Bool.True;
...
#else
            if (initialized && version >= OVRSP_1_6_0.version)
                OVRSP_1_6_0.ovrp_SetTrackingIPDEnabled(ToBool(value));
#endif
        }
    }
    ...
    public static bool positionSupported
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetTrackingPositionSupported() == Bool.True;
#endif
        }
    }
    ...
    public static bool positionTracked
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetNodePositionTracked(Node.EyeCenter) == Bool.True;
#endif
        }
    }
    ...
    public static bool powerSaving
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetSystemPowerSavingMode() == Bool.True;
#endif
        }
    }
    ...
    public static bool hmdPresent
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetNodePresent(Node.EyeCenter) == Bool.True;
#endif
        }
    }
    ...
    public static bool userPresent
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_1_0.ovrp_GetUserPresent() == Bool.True;
#endif
        }
    }
    ...
    public static bool headphonesPresent
    {
        get
        {
            ...
            return false;
#else
            return initialized && OVRSP_1_3_0.ovrp_GetSystemHeadphonesPresent() == OVRSPlugin.Bool.True;
#endif
        }
    }
...
#else
            if (initialized && version >= OVRSP_1_6_0.version)
                return OVRSP_1_6_0.ovrp_GetSystemRecommendedMSAALevel();
            else
                return 2;
#endif
        }
...
#else
            if (initialized && version >= OVRSP_1_5_0.version)
                return OVRSP_1_5_0.ovrp_GetSystemRegion();
            else
                return SystemRegion.Unspecified;
#endif
        }
...
#if !OVRSPLUGIN_UNSUPPORTED_PLATFORM
    private static GUID _nativeAudioOutGuid = new OVRSPlugin.GUID();
        ...
        get
        {
            ...
            try
            {
                if (_nativeAudioOutGuid == null)
                    _nativeAudioOutGuid = new OVRSPlugin.GUID();

                IntPtr ptr = OVRSP_1_1_0.ovrp_GetAudioOutId();
                if (ptr != IntPtr.Zero)
                {
...
#if !OVRSPLUGIN_UNSUPPORTED_PLATFORM
    private static GUID _nativeAudioInGuid = new OVRSPlugin.GUID();
        ...
        get
        {
            ...
            try
            {
                if (_nativeAudioInGuid == null)
                    _nativeAudioInGuid = new OVRSPlugin.GUID();

                IntPtr ptr = OVRSP_1_1_0.ovrp_GetAudioInId();
                if (ptr != IntPtr.Zero)
                {
    ...
    public static bool hasVrFocus
    {
        get
        {
            ...
            return false;
#else
            return OVRSP_1_1_0.ovrp_GetAppHasVrFocus() == Bool.True;
#endif
        }
    }
    ...
    public static bool hasInputFocus
    {
        get
        {
            ...
            return true;
#else
            if (version >= OVRSP_1_18_0.version)
            {
                Bool inputFocus = Bool.False;
                Result result = OVRSP_1_18_0.ovrp_GetAppHasInputFocus(out inputFocus);
    ...
    public static bool shouldQuit
    {
        get
        {
            ...
            return false;
#else
            return OVRSP_1_1_0.ovrp_GetAppShouldQuit() == Bool.True;
#endif
        }
    }
    ...
    public static bool shouldRecenter
    {
        get
        {
            ...
            return false;
#else
            return OVRSP_1_1_0.ovrp_GetAppShouldRecenter() == Bool.True;
#endif
        }
    }
    ...
    public static string productName
    {
        get
        {
            ...
            return string.Empty;
#else
            return OVRSP_1_1_0.ovrp_GetSystemProductName();
#endif
        }
    }
    ...
    public static string latency
    {
        get
        {
            ...
            return OVRSP_1_1_0.ovrp_GetAppLatencyTimings();
#endif
        }
    }
    ...
    public static float eyeDepth
    {
        get
        {
            ...
            return OVRSP_1_1_0.ovrp_GetUserEyeDepth();
#endif
        }
        set
        {
            ...
            return;
#else
            OVRSP_1_1_0.ovrp_SetUserEyeDepth(value);
#endif
        }
    }
    ...
    public static float eyeHeight
    {
        get
        {
            ...
            return 0.0f;
#else
            return OVRSP_1_1_0.ovrp_GetUserEyeHeight();
#endif
        }
        set
        {
            ...
            return;
#else
            OVRSP_1_1_0.ovrp_SetUserEyeHeight(value);
#endif
        }
    }
    ...
    public static float batteryLevel
    {
        get
        {
            ...
            return 0.0f;
#else
            return OVRSP_1_1_0.ovrp_GetSystemBatteryLevel();
#endif
        }
    }
    ...
    public static float batteryTemperature
    {
        get
        {
            ...
            return 0.0f;
#else
            return OVRSP_1_1_0.ovrp_GetSystemBatteryTemperature();
#endif
        }
    }
    ...
    public static ProcessorPerformanceLevel suggestedCpuPerfLevel
    {
...
#else
            if (version >= OVRSP_1_71_0.version)
            {
                ProcessorPerformanceLevel level;
                if (OVRSP_1_71_0.ovrp_GetSuggestedCpuPerformanceLevel(out level) == Result.Success)
                {
                    return level;
                }
            }
        ...
        set
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_SetSuggestedCpuPerformanceLevel(value);
            }
#endif
        }
    }
    ...
    public static ProcessorPerformanceLevel suggestedGpuPerfLevel
    {
        get
        {
            ...
            {
                ProcessorPerformanceLevel level;
                if (OVRSP_1_71_0.ovrp_GetSuggestedGpuPerformanceLevel(out level) == Result.Success)
                {
                    return level;
                }
            }
        ...
        set
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_SetSuggestedGpuPerformanceLevel(value);
            }
#endif
        }
    }
    ...
    public static int cpuLevel
    {
        get
        {
            ...
            return 0;
#else
            return OVRSP_1_1_0.ovrp_GetSystemCpuLevel();
#endif
        }
        set
        {
            ...
            return;
#else
            OVRSP_1_1_0.ovrp_SetSystemCpuLevel(value);
#endif
        }
    }
    ...
    public static int gpuLevel
    {
        get
        {
            ...
            return 0;
#else
            return OVRSP_1_1_0.ovrp_GetSystemGpuLevel();
#endif
        }
        set
        {
            ...
            return;
#else
            OVRSP_1_1_0.ovrp_SetSystemGpuLevel(value);
#endif
        }
    }
    ...
    public static int vsyncCount
    {
        get
        {
            ...
            return 0;
#else
            return OVRSP_1_1_0.ovrp_GetSystemVSyncCount();
#endif
        }
        set
        {
            ...
            return;
#else
            OVRSP_1_2_0.ovrp_SetSystemVSyncCount(value);
#endif
        }
    }
    ...
    public static float systemVolume
    {
        get
        {
            ...
            return 0.0f;
#else
            return OVRSP_1_1_0.ovrp_GetSystemVolume();
#endif
        }
    }
    ...
    public static float ipd
    {
        get
        {
            ...
            return 0.0f;
#else
            return OVRSP_1_1_0.ovrp_GetUserIPD();
#endif
        }
        set
        {
            ...
            return;
#else
            OVRSP_1_1_0.ovrp_SetUserIPD(value);
#endif
        }
    }
    ...
    public static bool occlusionMesh
    {
        get
        {
            ...
            return false;
#else
            return initialized && (OVRSP_1_3_0.ovrp_GetEyeOcclusionMeshEnabled() == Bool.True);
#endif
        }
        set
        {
            ...
            OVRSP_1_3_0.ovrp_SetEyeOcclusionMeshEnabled(ToBool(value));
#endif
        }
    }
    ...
    public static bool premultipliedAlphaLayersSupported
    {
        get
        {
            ...
            return false;
#else
            return !Application.isMobilePlatform && version >= OVRSP_1_3_0.version;
#endif
        }
    }
...
#else
            return OVRSP_1_1_0.ovrp_GetSystemBatteryStatus();
#endif
        }
    }
    ...
    public static Frustumf GetEyeFrustum(Eye eyeId)
    {
        ...
        return new Frustumf();
#else
        return OVRSP_1_1_0.ovrp_GetNodeFrustum((Node)eyeId);
#endif
    }
    ...
    public static Sizei GetEyeTextureSize(Eye eyeId)
    {
        ...
        return new Sizei();
#else
        return OVRSP_0_1_0.ovrp_GetEyeTextureSize(eyeId);
#endif
    }
    ...
    public static Frustumf GetTrackerFrustum(Tracker trackerId)
    {
        ...
        return new Frustumf();
#else
        return OVRSP_1_1_0.ovrp_GetNodeFrustum((Node)((int)trackerId + (int)Node.TrackerZero));
#endif
    }
    ...
    public static bool ShowUI(PlatformUI ui)
    {
        ...
        return false;
#else
        return OVRSP_1_1_0.ovrp_ShowSystemUI(ui) == Bool.True;
#endif
    }
    ...
    )
    {
        ...
        if (version >= OVRSP_1_6_0.version)
        {
            ...
            if (shape == OverlayShape.Cylinder || shape == OverlayShape.Cubemap)
            {
                ...
                if (version < OVRSP_1_7_0.version)
                    return false;
#else
                if (shape == OverlayShape.Cubemap && version < OVRSP_1_10_0.version)
                    return false;
                else if (shape == OverlayShape.Cylinder && version < OVRSP_1_16_0.version)
                    return false;
#endif
            }
            ...
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                if (version < OVRSP_1_11_0.version)
                    return false;
#else
                return false;
#endif
            ...
            {
#if UNITY_ANDROID && !UNITY_EDITOR
                if (version < OVRSP_1_21_0.version)
                    return false;
#else
                return false;
#endif
            ...
            if (version >= OVRSP_1_34_0.version && layerId != -1)
                return OVRSP_1_34_0.ovrp_EnqueueSubmitLayer2(flags, leftTexture, rightTexture, layerId, frameIndex,
            ...
            else if (version >= OVRSP_1_15_0.version && layerId != -1)
                return OVRSP_1_15_0.ovrp_EnqueueSubmitLayer(flags, leftTexture, rightTexture, layerId, frameIndex,
                    ref pose, ref scale, layerIndex) == Result.Success;

            return OVRSP_1_6_0.ovrp_SetOverlayQuad3(flags, leftTexture, rightTexture, IntPtr.Zero, pose, scale,
        ...
        return OVRSP_0_1_1.ovrp_SetOverlayQuad2(ToBool(onTop), ToBool(headLocked), leftTexture, IntPtr.Zero, pose,
            scale) == Bool.True;
#endif
    }
...
#else
        if (!initialized || version < OVRSP_1_15_0.version)
        {
            return new LayerDesc();
        }

        LayerDesc layerDesc = new LayerDesc();
        OVRSP_1_15_0.ovrp_CalculateLayerDesc(shape, layout, ref textureSize, mipLevels, sampleCount,
    ...
    public static bool EnqueueSetupLayer(LayerDesc desc, int compositionDepth, IntPtr layerID)
    {
        ...
        if (version >= OVRSP_1_28_0.version)
        {
            return OVRSP_1_28_0.ovrp_EnqueueSetupLayer2(ref desc, compositionDepth, layerID) ==
                   Result.Success;
        }

        if (version >= OVRSP_1_15_0.version)
        {
            ...
            return OVRSP_1_15_0.ovrp_EnqueueSetupLayer(ref desc, layerID) == Result.Success;
        }
    ...
    public static bool EnqueueDestroyLayer(IntPtr layerID)
    {
        ...
        if (!initialized)
            return false;
        if (version >= OVRSP_1_15_0.version)
            return OVRSP_1_15_0.ovrp_EnqueueDestroyLayer(layerID) == Result.Success;
    ...
    public static IntPtr GetLayerTexture(int layerId, int stage, Eye eyeId)
    {
        ...
        if (version >= OVRSP_1_15_0.version)
            OVRSP_1_15_0.ovrp_GetLayerTexturePtr(layerId, stage, eyeId, ref textureHandle);
    ...
    public static int GetLayerTextureStageCount(int layerId)
    {
        ...
        if (version >= OVRSP_1_15_0.version)
            OVRSP_1_15_0.ovrp_GetLayerTextureStageCount(layerId, ref stageCount);
    ...
    public static IntPtr GetLayerAndroidSurfaceObject(int layerId)
    {
        ...
        if (version >= OVRSP_1_29_0.version)
            OVRSP_1_29_0.ovrp_GetLayerAndroidSurfaceObject(layerId, ref surfaceObject);
    ...
    public static bool UpdateInBatchMode()
    {
        ...
        if (version >= OVRSP_1_8_0.version)
            return OVRSP_1_8_0.ovrp_Update2((int)Step.Render, -1 /*OVRSP_CURRENT_FRAMEINDEX*//*, 0.0) == Bool.True;
    ...
    public static bool GetTrackingPoseEnabledForInvisibleSession()
    {
        ...
        if (version >= OVRSP_1_99_0.version)
            OVRSP_1_99_0.ovrp_GetTrackingPoseEnabledForInvisibleSession(out enabled);
...
#else
        if (version >= OVRSP_1_99_0.version)
            OVRSP_1_99_0.ovrp_SetTrackingPoseEnabledForInvisibleSession(enabled ? Bool.True : Bool.False);
#endif
    }
#endif
...
#else
        if (version >= OVRSP_1_8_0.version)
            return OVRSP_1_8_0.ovrp_Update2((int)Step.Physics, frameIndex, predictionSeconds) == Bool.True;
    ...
    public static Posef GetNodePose(Node nodeId, Step stepId)
    {
        ...
        if (version >= OVRSP_1_12_0.version)
            return OVRSP_1_12_0.ovrp_GetNodePoseState(stepId, nodeId).Pose;

        if (version >= OVRSP_1_8_0.version && stepId == Step.Physics)
            return OVRSP_1_8_0.ovrp_GetNodePose2(0, nodeId);

        return OVRSP_0_1_2.ovrp_GetNodePose(nodeId);
#endif
    }
    ...
    public static Vector3f GetNodeVelocity(Node nodeId, Step stepId)
    {
        ...
        if (version >= OVRSP_1_12_0.version)
            return OVRSP_1_12_0.ovrp_GetNodePoseState(stepId, nodeId).Velocity;

        if (version >= OVRSP_1_8_0.version && stepId == Step.Physics)
            return OVRSP_1_8_0.ovrp_GetNodeVelocity2(0, nodeId).Position;

        return OVRSP_0_1_3.ovrp_GetNodeVelocity(nodeId).Position;
#endif
    }
    ...
    public static Vector3f GetNodeAngularVelocity(Node nodeId, Step stepId)
    {
        ...
        if (version >= OVRSP_1_12_0.version)
            return OVRSP_1_12_0.ovrp_GetNodePoseState(stepId, nodeId).AngularVelocity;
    ...
    public static Vector3f GetNodeAcceleration(Node nodeId, Step stepId)
    {
        ...
        if (version >= OVRSP_1_12_0.version)
            return OVRSP_1_12_0.ovrp_GetNodePoseState(stepId, nodeId).Acceleration;

        if (version >= OVRSP_1_8_0.version && stepId == Step.Physics)
            return OVRSP_1_8_0.ovrp_GetNodeAcceleration2(0, nodeId).Position;

        return OVRSP_0_1_3.ovrp_GetNodeAcceleration(nodeId).Position;
#endif
    }
    ...
    public static Vector3f GetNodeAngularAcceleration(Node nodeId, Step stepId)
    {
        ...
        if (version >= OVRSP_1_12_0.version)
            return OVRSP_1_12_0.ovrp_GetNodePoseState(stepId, nodeId).AngularAcceleration;
    ...
    public static bool GetNodePresent(Node nodeId)
    {
        ...
        return false;
#else
        return OVRSP_1_1_0.ovrp_GetNodePresent(nodeId) == Bool.True;
#endif
    }
    ...
    public static bool GetNodeOrientationTracked(Node nodeId)
    {
        ...
        return false;
#else
        return OVRSP_1_1_0.ovrp_GetNodeOrientationTracked(nodeId) == Bool.True;
#endif
    }
    ...
    public static bool GetNodeOrientationValid(Node nodeId)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_38_0.version)
        {
            Bool orientationValid = Bool.False;
            Result result = OVRSP_1_38_0.ovrp_GetNodeOrientationValid(nodeId, ref orientationValid);
    ...
    public static bool GetNodePositionTracked(Node nodeId)
    {
        ...
        return false;
#else
        return OVRSP_1_1_0.ovrp_GetNodePositionTracked(nodeId) == Bool.True;
#endif
    }
    ...
    public static bool GetNodePositionValid(Node nodeId)
    {
        ...
        if (version >= OVRSP_1_38_0.version)
        {
            ...
            Result result = OVRSP_1_38_0.ovrp_GetNodePositionValid(nodeId, ref positionValid);
    ...
    public static PoseStatef GetNodePoseStateRaw(Node nodeId, Step stepId)
    {
        ...
        if (version >= OVRSP_1_29_0.version)
        {
            ...
            Result result = OVRSP_1_29_0.ovrp_GetNodePoseStateRaw(stepId, -1, nodeId, out nodePoseState);
            if (result == Result.Success)
            {
        ...
        if (version >= OVRSP_1_12_0.version)
            return OVRSP_1_12_0.ovrp_GetNodePoseState(stepId, nodeId);
        else
            return PoseStatef.identity;
#endif
    }
    ...
    public static PoseStatef GetNodePoseStateAtTime(double time, Node nodeId)
    {
        ...
        return PoseStatef.identity;
#else
        if (version >= OVRSP_1_76_0.version)
        {
            PoseStatef nodePoseState;
            Result result = OVRSP_1_76_0.ovrp_GetNodePoseStateAtTime(time, nodeId, out nodePoseState);
            if (result == Result.Success)
            {
                return nodePoseState;
            }
    ...
    public static PoseStatef GetNodePoseStateImmediate(Node nodeId)
    {
        ...
        return PoseStatef.identity;
#else
        if (version >= OVRSP_1_69_0.version)
        {
            PoseStatef nodePoseState;
            Result result = OVRSP_1_69_0.ovrp_GetNodePoseStateImmediate(nodeId, out nodePoseState);
            if (result == Result.Success)
            {
                return nodePoseState;
            }
    ...
    public static bool AreHandPosesGeneratedByControllerData(Step stepId, Node nodeId)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_86_0.version)
        {
            Bool generatedByController = Bool.False;
            Result result = OVRSP_1_86_0.ovrp_AreHandPosesGeneratedByControllerData(stepId, nodeId, ref generatedByController);
    ...
    public static bool SetSimultaneousHandsAndControllersEnabled(bool enabled)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_88_0.version)
        {
            Result result = OVRSP_1_88_0.ovrp_SetSimultaneousHandsAndControllersEnabled(enabled ? Bool.True : Bool.False);
            if (result == Result.Success)
            {
                return true;
            }
    ...
    public static bool GetControllerIsInHand(Step stepId, Node nodeId)
    {
        ...
        if (version >= OVRSP_1_86_0.version)
        {
            ...
            Result result = OVRSP_1_86_0.ovrp_GetControllerIsInHand(stepId, nodeId, ref isInHand);
    ...
    public static Posef GetCurrentTrackingTransformPose()
    {
        ...
        return Posef.identity;
#else
        if (version >= OVRSP_1_30_0.version)
        {
            Posef trackingTransformPose;
            Result result = OVRSP_1_30_0.ovrp_GetCurrentTrackingTransformPose(out trackingTransformPose);
            if (result == Result.Success)
            {
    ...
    public static Posef GetTrackingTransformRawPose()
    {
        ...
        if (version >= OVRSP_1_30_0.version)
        {
            ...
            Result result = OVRSP_1_30_0.ovrp_GetTrackingTransformRawPose(out trackingTransforRawPose);
            if (result == Result.Success)
            {
    ...
    public static Posef GetTrackingTransformRelativePose(TrackingOrigin trackingOrigin)
    {
        ...
        if (version >= OVRSP_1_38_0.version)
        {
            ...
            Result result =
                OVRSP_1_38_0.ovrp_GetTrackingTransformRelativePose(ref trackingTransformRelativePose, trackingOrigin);
            if (result == Result.Success)
            {
...
#else
        return OVRSP_1_1_0.ovrp_GetControllerState(controllerMask);
#endif
    }
    ...
    public static ControllerState2 GetControllerState2(uint controllerMask)
    {
        ...
        if (version >= OVRSP_1_12_0.version)
        {
            return OVRSP_1_12_0.ovrp_GetControllerState2(controllerMask);
        }

        return new ControllerState2(OVRSP_1_1_0.ovrp_GetControllerState(controllerMask));
#endif
    }
...
#else
        if (version >= OVRSP_1_16_0.version)
        {
            ControllerState4 controllerState = new ControllerState4();
            OVRSP_1_16_0.ovrp_GetControllerState4(controllerMask, ref controllerState);
...
#else
        if (version >= OVRSP_1_78_0.version)
        {
            ControllerState5 controllerState = new ControllerState5();
            OVRSP_1_78_0.ovrp_GetControllerState5(controllerMask, ref controllerState);
            return controllerState;
        }
...
#else
        if (version >= OVRSP_1_83_0.version)
        {
            ControllerState6 controllerState = new ControllerState6();
            OVRSP_1_83_0.ovrp_GetControllerState6(controllerMask, ref controllerState);
            return controllerState;
        }
    ...
    public static InteractionProfile GetCurrentInteractionProfile(Hand hand)
    {
        ...
        if (version >= OVRSP_1_78_0.version)
        {
            OVRSP_1_78_0.ovrp_GetCurrentInteractionProfile(hand, out interactionProfile);
        }
    ...
    public static InteractionProfile GetCurrentDetachedInteractionProfile(Hand hand)
    {
        ...
        if (version >= OVRSP_1_86_0.version)
        {
            OVRSP_1_86_0.ovrp_GetCurrentDetachedInteractionProfile(hand, out interactionProfile);
        }
    ...
    public static string GetCurrentInteractionProfileName(Hand hand)
    {
        ...
        if (version >= OVRSP_1_100_0.version)
        {
            IntPtr pathPtr = IntPtr.Zero;
            try
            {
                pathPtr = Marshal.AllocHGlobal(sizeof(byte) * OVRSP_1_68_0.OVRSP_RENDER_MODEL_MAX_PATH_LENGTH);

                if (OVRSP_1_100_0.ovrp_GetCurrentInteractionProfileName(hand, pathPtr) == Result.Success)
                {
    ...
    public static bool SetControllerVibration(uint controllerMask, float frequency, float amplitude)
    {
        ...
        return false;
#else
        return OVRSP_0_1_2.ovrp_SetControllerVibration(controllerMask, frequency, amplitude) == Bool.True;
#endif
    }
        ...
        float frequency, float amplitude)
    {
        ...
        if (version >= OVRSP_1_78_0.version)
        {
            Result result = OVRSP_1_78_0.ovrp_SetControllerLocalizedVibration(controllerMask, hapticsLocationMask,
                frequency, amplitude);
        ...
        HapticsAmplitudeEnvelopeVibration hapticsVibration)
    {
        ...
        if (version >= OVRSP_1_78_0.version)
        {
            Result result = OVRSP_1_78_0.ovrp_SetControllerHapticsAmplitudeEnvelope(controllerMask, hapticsVibration);
            return (result == Result.Success);
        }
    ...
    public static bool SetControllerHapticsPcm(Controller controllerMask, HapticsPcmVibration hapticsVibration)
    {
        ...
        if (version >= OVRSP_1_78_0.version)
        {
            Result result = OVRSP_1_78_0.ovrp_SetControllerHapticsPcm(controllerMask, hapticsVibration);
            return (result == Result.Success);
        }
    ...
    public static bool GetControllerSampleRateHz(Controller controllerMask, out float sampleRateHz)
    {
        ...
        if (version >= OVRSP_1_78_0.version)
        {
            Result result = OVRSP_1_78_0.ovrp_GetControllerSampleRateHz(controllerMask, out sampleRateHz);
            return (result == Result.Success);
        }
    ...
    public static HapticsDesc GetControllerHapticsDesc(uint controllerMask)
    {
        ...
        if (version >= OVRSP_1_6_0.version)
        {
            return OVRSP_1_6_0.ovrp_GetControllerHapticsDesc(controllerMask);
        }
        else
        {
            return new HapticsDesc();
    ...
    public static HapticsState GetControllerHapticsState(uint controllerMask)
    {
        ...
        if (version >= OVRSP_1_6_0.version)
        {
            return OVRSP_1_6_0.ovrp_GetControllerHapticsState(controllerMask);
        }
        else
        {
            return new HapticsState();
    ...
    public static bool SetControllerHaptics(uint controllerMask, HapticsBuffer hapticsBuffer)
    {
        ...
        if (version >= OVRSP_1_6_0.version)
        {
            return OVRSP_1_6_0.ovrp_SetControllerHaptics(controllerMask, hapticsBuffer) == Bool.True;
        }
        else
        {
            return false;
    ...
    public static float GetEyeRecommendedResolutionScale()
    {
        ...
        if (version >= OVRSP_1_6_0.version)
        {
            return OVRSP_1_6_0.ovrp_GetEyeRecommendedResolutionScale();
        }
        else
        {
            return 1.0f;
    ...
    public static float GetAppCpuStartToGpuEndTime()
    {
        ...
        if (version >= OVRSP_1_6_0.version)
        {
            return OVRSP_1_6_0.ovrp_GetAppCpuStartToGpuEndTime();
        }
        else
        {
            return 0.0f;
    ...
    public static bool GetBoundaryConfigured()
    {
        ...
        if (version >= OVRSP_1_8_0.version)
        {
            return OVRSP_1_8_0.ovrp_GetBoundaryConfigured() == OVRSPlugin.Bool.True;
        }
        else
        {
            return false;
    ...
    public static BoundaryTestResult TestBoundaryNode(Node nodeId, BoundaryType boundaryType)
    {
        ...
        if (version >= OVRSP_1_8_0.version)
        {
            return OVRSP_1_8_0.ovrp_TestBoundaryNode(nodeId, boundaryType);
        }
        else
        {
            return new BoundaryTestResult();
    ...
    public static BoundaryTestResult TestBoundaryPoint(Vector3f point, BoundaryType boundaryType)
    {
        ...
        if (version >= OVRSP_1_8_0.version)
        {
            return OVRSP_1_8_0.ovrp_TestBoundaryPoint(point, boundaryType);
        }
        else
        {
            return new BoundaryTestResult();
    ...
    public static BoundaryGeometry GetBoundaryGeometry(BoundaryType boundaryType)
    {
        ...
        if (version >= OVRSP_1_8_0.version)
        {
            return OVRSP_1_8_0.ovrp_GetBoundaryGeometry(boundaryType);
        }
        else
        {
            return new BoundaryGeometry();
    ...
    public static bool GetBoundaryGeometry2(BoundaryType boundaryType, IntPtr points, ref int pointsCount)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_9_0.version)
        {
            return OVRSP_1_9_0.ovrp_GetBoundaryGeometry2(boundaryType, points, ref pointsCount) == OVRSPlugin.Bool.True;
        }
        else
        {
            pointsCount = 0;
    ...
    public static AppPerfStats GetAppPerfStats()
    {
        ...
        if (version >= OVRSP_1_9_0.version)
        {
            return OVRSP_1_9_0.ovrp_GetAppPerfStats();
        }
        else
        {
            return new AppPerfStats();
    ...
    public static bool ResetAppPerfStats()
    {
        ...
        if (version >= OVRSP_1_9_0.version)
        {
            return OVRSP_1_9_0.ovrp_ResetAppPerfStats() == OVRSPlugin.Bool.True;
        }
        else
        {
            return false;
    ...
    public static float GetAppFramerate()
    {
        ...
        if (version >= OVRSP_1_12_0.version)
        {
            return OVRSP_1_12_0.ovrp_GetAppFramerate();
        }
        else
        {
            return 0.0f;
    ...
    public static bool SetHandNodePoseStateLatency(double latencyInSeconds)
    {
        ...
        if (version >= OVRSP_1_18_0.version)
        {
            Result result = OVRSP_1_18_0.ovrp_SetHandNodePoseStateLatency(latencyInSeconds);
            if (result == Result.Success)
            {
                return true;
            }
    ...
    public static double GetHandNodePoseStateLatency()
    {
        ...
        {
            double value = 0.0;
            if (OVRSP_1_18_0.ovrp_GetHandNodePoseStateLatency(out value) == OVRSPlugin.Result.Success)
            {
                return value;
            }
            else
    ...
    public static bool SetControllerDrivenHandPoses(bool controllerDrivenHandPoses)
    {
        ...
        if (version >= OVRSP_1_86_0.version)
        {
            Result result = OVRSP_1_86_0.ovrp_SetControllerDrivenHandPoses(controllerDrivenHandPoses ? Bool.True : Bool.False);
            return (result == Result.Success);
        }
    ...
    public static bool SetControllerDrivenHandPosesAreNatural(bool controllerDrivenHandPosesAreNatural)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_87_0.version)
        {
            Result result = OVRSP_1_87_0.ovrp_SetControllerDrivenHandPosesAreNatural(controllerDrivenHandPosesAreNatural ? Bool.True : Bool.False);
            return (result == Result.Success);
        }
    ...
    public static bool IsControllerDrivenHandPosesEnabled()
    {
        ...
        if (version >= OVRSP_1_86_0.version)
        {
            Bool enabled = OVRSPlugin.Bool.False;
            Result result = OVRSP_1_86_0.ovrp_IsControllerDrivenHandPosesEnabled(ref enabled);
            if (result == Result.Success)
            {
                return enabled == OVRSPlugin.Bool.True;
            }
    ...
    public static bool AreControllerDrivenHandPosesNatural()
    {
        ...
        {
            Bool enabled = OVRSPlugin.Bool.False;
            Result result = OVRSP_1_87_0.ovrp_AreControllerDrivenHandPosesNatural(ref enabled);
            if (result == Result.Success)
            {
                return enabled == OVRSPlugin.Bool.True;
            }
    ...
    public static bool SetHandSkeletonVersion(OVRSHandSkeletonVersion skeletonVersion)
    {
#if OVRSPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        if (skeletonVersion == OVRSHandSkeletonVersion.Uninitialized)
        {
            HandSkeletonVersion = skeletonVersion;
            return false;
        }

        if (version >= OVRSP_1_103_0.version)
        {
            Result result = OVRSP_1_103_0.ovrp_SetHandSkeletonVersion(skeletonVersion);
            if (result == Result.Success)
            {
                HandSkeletonVersion = skeletonVersion;
            }
        ...
        return false;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
    ...
    public static bool GetActionStateBoolean(string actionName, out bool result)
    {
        ...
        if (version >= OVRSP_1_95_0.version)
        {
            var outcome = OVRSP_1_95_0.ovrp_GetActionStateBoolean(actionName, ref ovrResult);
    ...
    public static bool GetActionStateFloat(string actionName, out float result)
    {
        ...
        if (version >= OVRSP_1_95_0.version)
        {
            var outcome = OVRSP_1_95_0.ovrp_GetActionStateFloat(actionName, ref result);
            if (outcome == Result.Success)
            {
                return true;
            }
    ...
    public static bool GetActionStatePose(string actionName, out Posef result)
    {
        ...
        if (version >= OVRSP_1_95_0.version)
        {
            var outcome = OVRSP_1_95_0.ovrp_GetActionStatePose(actionName, ref result);
            if (outcome == Result.Success)
            {
                return true;
            }
    ...
    public static bool GetActionStatePose(string actionName, Hand hand, out Posef result)
    {
        ...
        if (version >= OVRSP_1_100_0.version)
        {
            var outcome = OVRSP_1_100_0.ovrp_GetActionStatePose2(actionName, hand, ref result);
            if (outcome == Result.Success)
            {
                return true;
            }
    ...
    public static bool TriggerVibrationAction(string actionName, Hand hand, float duration, float amplitude)
    {
        ...
        if (version >= OVRSP_1_100_0.version)
        {
            var outcome = OVRSP_1_100_0.ovrp_TriggerVibrationAction(actionName, hand, duration, amplitude);
            if (outcome == Result.Success)
            {
                return true;
            }
    ...
    public static bool SetWideMotionModeHandPoses(bool wideMotionModeFusionHandPoses)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_93_0.version)
        {
            Result result = OVRSP_1_93_0.ovrp_SetWideMotionModeHandPoses(wideMotionModeFusionHandPoses ? Bool.True : Bool.False);
            return (result == Result.Success);
        }
    ...
    public static bool IsWideMotionModeHandPosesEnabled()
    {
        ...
        {
            Bool enabled = OVRSPlugin.Bool.False;
            Result result = OVRSP_1_93_0.ovrp_IsSetWideMotionModeHandPosesEnabled(ref enabled);
            if (result == Result.Success)
            {
                return enabled == OVRSPlugin.Bool.True;
            }
    ...
    public static EyeTextureFormat GetDesiredEyeTextureFormat()
    {
        ...
        if (version >= OVRSP_1_11_0.version)
        {
            uint eyeTextureFormatValue = (uint)OVRSP_1_11_0.ovrp_GetDesiredEyeTextureFormat();
    ...
    public static bool SetDesiredEyeTextureFormat(EyeTextureFormat value)
    {
        ...
        if (version >= OVRSP_1_11_0.version)
        {
            return OVRSP_1_11_0.ovrp_SetDesiredEyeTextureFormat(value) == OVRSPlugin.Bool.True;
        }
        else
        {
            return false;
...
#if OVRSPLUGIN_INCLUDE_MRC_ANDROID
        if (version >= OVRSP_1_38_0.version) // MRC functions are invalid before 1.38.0
#else
        if (version >= OVRSP_1_15_0.version)
#endif
        {
            Result result = OVRSP_1_15_0.ovrp_InitializeMixedReality();
            if (result != Result.Success)
            {
...
#endif
        {
            Result result = OVRSP_1_15_0.ovrp_ShutdownMixedReality();
            if (result != Result.Success)
            {
...
#endif
        {
            return OVRSP_1_15_0.ovrp_GetMixedRealityInitialized() == Bool.True;
        }
        else
        {
            return false;
    ...
    public static int GetExternalCameraCount()
    {
        ...
        {
            int cameraCount = 0;
            Result result = OVRSP_1_15_0.ovrp_GetExternalCameraCount(out cameraCount);
            if (result != OVRSPlugin.Result.Success)
            {
...
#endif
        {
            Result result = OVRSP_1_15_0.ovrp_UpdateExternalCamera();
            if (result != Result.Success)
            {
        ...
        out CameraIntrinsics cameraIntrinsics)
    {
...
#endif
        {
            ...
            Result result = OVRSP_1_15_0.ovrp_GetExternalCameraExtrinsics(cameraId, out cameraExtrinsics);
            if (result != Result.Success)
            {
                retValue = false;
            ...
            result = OVRSP_1_15_0.ovrp_GetExternalCameraIntrinsics(cameraId, out cameraIntrinsics);
            if (result != Result.Success)
            {
                retValue = false;
    ...
    public static bool OverrideExternalCameraFov(int cameraId, bool useOverriddenFov, Fovf fov)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_44_0.version)
        {
            bool retValue = true;
            Result result = OVRSP_1_44_0.ovrp_OverrideExternalCameraFov(cameraId,
    ...
    public static bool GetUseOverriddenExternalCameraFov(int cameraId)
    {
        ...
        if (version >= OVRSP_1_44_0.version)
        {
            ...
            Result result = OVRSP_1_44_0.ovrp_GetUseOverriddenExternalCameraFov(cameraId, out useOverriddenFov);
            if (result != Result.Success)
            {
                retValue = false;
            }
    ...
    public static bool OverrideExternalCameraStaticPose(int cameraId, bool useOverriddenPose, Posef poseInStageOrigin)
    {
        ...
        {
            bool retValue = true;
            Result result = OVRSP_1_44_0.ovrp_OverrideExternalCameraStaticPose(cameraId,
    ...
    public static bool GetUseOverriddenExternalCameraStaticPose(int cameraId)
    {
        ...
        if (version >= OVRSP_1_44_0.version)
        {
            ...
            Result result =
                OVRSP_1_44_0.ovrp_GetUseOverriddenExternalCameraStaticPose(cameraId, out useOverriddenStaticPose);
            if (result != Result.Success)
            {
                retValue = false;
            }
    ...
    public static bool ResetDefaultExternalCamera()
    {
        ...
        if (version >= OVRSP_1_44_0.version)
        {
            Result result = OVRSP_1_44_0.ovrp_ResetDefaultExternalCamera();
            if (result != Result.Success)
            {
                return false;
            }
        ...
        ref CameraExtrinsics cameraExtrinsics)
    {
        ...
        {
            Result result =
                OVRSP_1_44_0.ovrp_SetDefaultExternalCamera(cameraName, ref cameraIntrinsics, ref cameraExtrinsics);
            if (result != Result.Success)
            {
                return false;
            }
        ...
        ref CameraExtrinsics cameraExtrinsics)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_48_0.version)
        {
            Result result =
                OVRSP_1_48_0.ovrp_SetExternalCameraProperties(cameraName, ref cameraIntrinsics, ref cameraExtrinsics);
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static bool SetMultimodalHandsControllersSupported(bool value)
    {
        ...
        if (version >= OVRSP_1_86_0.version)
        {
            Result result = OVRSP_1_86_0.ovrp_SetMultimodalHandsControllersSupported(ToBool(value));
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static bool IsMultimodalHandsControllersSupported()
    {
        ...
        if (version >= OVRSP_1_86_0.version)
        {
            Bool supported = OVRSPlugin.Bool.False;
            Result result = OVRSP_1_86_0.ovrp_IsMultimodalHandsControllersSupported(ref supported);
            if (result == Result.Success)
            {
                return supported == OVRSPlugin.Bool.True;
            }
    ...
    public static bool IsInsightPassthroughSupported()
    {
        ...
        {
            Bool supported = OVRSPlugin.Bool.False;
            Result result = OVRSP_1_71_0.ovrp_IsInsightPassthroughSupported(ref supported);
            if (result == Result.Success)
            {
                return supported == OVRSPlugin.Bool.True;
            }
    ...
    public static bool InitializeInsightPassthrough()
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_63_0.version)
        {
            Result result = OVRSP_1_63_0.ovrp_InitializeInsightPassthrough();
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static bool ShutdownInsightPassthrough()
    {
        ...
        if (version >= OVRSP_1_63_0.version)
        {
            Result result = OVRSP_1_63_0.ovrp_ShutdownInsightPassthrough();
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static bool IsInsightPassthroughInitialized()
    {
        ...
        if (version >= OVRSP_1_63_0.version)
        {
            Bool result = OVRSP_1_63_0.ovrp_GetInsightPassthroughInitialized();
...
#else
        if (version >= OVRSP_1_66_0.version)
        {
            return OVRSP_1_66_0.ovrp_GetInsightPassthroughInitializationState();
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    public static bool CreateInsightTriangleMesh(int layerId, Vector3[] vertices, int[] triangles, out ulong meshHandle)
    {
        ...
        if (version >= OVRSP_1_63_0.version)
        {
            ...
            Result result = OVRSP_1_63_0.ovrp_CreateInsightTriangleMesh(
    ...
    public static bool DestroyInsightTriangleMesh(ulong meshHandle)
    {
        ...
        if (version >= OVRSP_1_63_0.version)
        {
            Result result = OVRSP_1_63_0.ovrp_DestroyInsightTriangleMesh(meshHandle);
            if (result != Result.Success)
            {
                return false;
            }
        ...
        out ulong geometryInstanceHandle)
    {
        ...
        if (version >= OVRSP_1_63_0.version)
        {
            Result result = OVRSP_1_63_0.ovrp_AddInsightPassthroughSurfaceGeometry(layerId, meshHandle, T_world_model,
    ...
    public static bool DestroyInsightPassthroughGeometryInstance(ulong geometryInstanceHandle)
    {
        ...
        if (version >= OVRSP_1_63_0.version)
        {
            Result result = OVRSP_1_63_0.ovrp_DestroyInsightPassthroughGeometryInstance(geometryInstanceHandle);
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static bool UpdateInsightPassthroughGeometryTransform(ulong geometryInstanceHandle, Matrix4x4 transform)
    {
        ...
        {
            Result result =
                OVRSP_1_63_0.ovrp_UpdateInsightPassthroughGeometryTransform(geometryInstanceHandle, transform);
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static bool SetInsightPassthroughStyle(int layerId, InsightPassthroughStyle2 style)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_84_0.version)
        {
            Result result = OVRSP_1_84_0.ovrp_SetInsightPassthroughStyle2(layerId, in style);
            return IsSuccess(result);
        }
        else if (version >= OVRSP_1_63_0.version)
        {
            ...
            {
                Debug.LogError("Only OVRSPlugn version 1.84.0 or higher supports Color LUTs");
                return false;
            }

            var oldStyle = new InsightPassthroughStyle();
            style.CopyTo(ref oldStyle);
            Result result = OVRSP_1_63_0.ovrp_SetInsightPassthroughStyle(layerId, oldStyle);
            return IsSuccess(result);
        }
        else
        {
    ...
    public static bool SetInsightPassthroughStyle(int layerId, InsightPassthroughStyle style)
    {
        ...
        if (version >= OVRSP_1_63_0.version)
        {
            Result result = OVRSP_1_63_0.ovrp_SetInsightPassthroughStyle(layerId, style);
            return IsSuccess(result);
        }
        else
        {
        ...
        PassthroughColorLutData data, out ulong colorLut)
    {
        ...
        if (version >= OVRSP_1_84_0.version)
        {
            Result result = OVRSP_1_84_0.ovrp_CreatePassthroughColorLut(channels, resolution, data, out colorLut);
            return IsSuccess(result);
        }
        else
        {
    ...
    public static bool DestroyPassthroughColorLut(ulong colorLut)
    {
        ...
        if (version >= OVRSP_1_84_0.version)
        {
            Result result = OVRSP_1_84_0.ovrp_DestroyPassthroughColorLut(colorLut);
            return IsSuccess(result);
        }
        else
        {
    ...
    public static bool UpdatePassthroughColorLut(ulong colorLut, PassthroughColorLutData data)
    {
        ...
        if (version >= OVRSP_1_84_0.version)
        {
            Result result = OVRSP_1_84_0.ovrp_UpdatePassthroughColorLut(colorLut, data);
            return IsSuccess(result);
        }
        else
        {
        ...
        InsightPassthroughKeyboardHandsIntensity intensity)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_68_0.version)
        {
            Result result = OVRSP_1_68_0.ovrp_SetInsightPassthroughKeyboardHandsIntensity(layerId, intensity);
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static PassthroughCapabilityFlags GetPassthroughCapabilityFlags()
    {
        ...
        if (version >= OVRSP_1_78_0.version)
        {
            ...
            Result result = OVRSP_1_78_0.ovrp_GetPassthroughCapabilityFlags(ref returnValue);
            if (result == Result.Success)
            {
                return returnValue;
            }
        ...
        {
            Debug.LogWarning("ovrp_GetPassthroughCapabilityFlags() not yet supported by OVRSPlugin. Result of " +
    ...
    public static Vector3f GetBoundaryDimensions(BoundaryType boundaryType)
    {
        ...
        if (version >= OVRSP_1_8_0.version)
        {
            return OVRSP_1_8_0.ovrp_GetBoundaryDimensions(boundaryType);
        }
        else
        {
            return new Vector3f();
    ...
    public static bool GetBoundaryVisible()
    {
        ...
        if (version >= OVRSP_1_8_0.version)
        {
            return OVRSP_1_8_0.ovrp_GetBoundaryVisible() == OVRSPlugin.Bool.True;
        }
        else
        {
            return false;
    ...
    public static bool SetBoundaryVisible(bool value)
    {
        ...
        if (version >= OVRSP_1_8_0.version)
        {
            return OVRSP_1_8_0.ovrp_SetBoundaryVisible(ToBool(value)) == OVRSPlugin.Bool.True;
        }
        else
        {
            return false;
...
#else
        if (version >= OVRSP_1_9_0.version)
            return OVRSP_1_9_0.ovrp_GetSystemHeadsetType();
...
#else
        if (version >= OVRSP_1_9_0.version)
            return OVRSP_1_9_0.ovrp_GetActiveController();
...
#else
        if (version >= OVRSP_1_9_0.version)
            return OVRSP_1_9_0.ovrp_GetConnectedControllers();
    ...
    {
        return (b) ? OVRSPlugin.Bool.True : OVRSPlugin.Bool.False;
    }
...
#else
        return OVRSP_1_0_0.ovrp_GetTrackingOriginType();
#endif
    }
    ...
    public static bool SetTrackingOriginType(TrackingOrigin originType)
    {
        ...
        return false;
#else
        return OVRSP_1_0_0.ovrp_SetTrackingOriginType(originType) == Bool.True;
#endif
    }
    ...
    public static Posef GetTrackingCalibratedOrigin()
    {
        ...
        return Posef.identity;
#else
        return OVRSP_1_0_0.ovrp_GetTrackingCalibratedOrigin();
#endif
    }
    ...
    public static bool SetTrackingCalibratedOrigin()
    {
        ...
        return false;
#else
        return OVRSP_1_2_0.ovrpi_SetTrackingCalibratedOrigin() == Bool.True;
#endif
    }
    ...
    public static bool RecenterTrackingOrigin(RecenterFlags flags)
    {
        ...
        return false;
#else
        return OVRSP_1_0_0.ovrp_RecenterTrackingOrigin((uint)flags) == Bool.True;
#endif
    }
    ...
    public static bool UpdateCameraDevices()
    {
        ...
        if (version >= OVRSP_1_16_0.version)
        {
            Result result = OVRSP_1_16_0.ovrp_UpdateCameraDevices();
            if (result != Result.Success)
            {
    ...
    public static bool IsCameraDeviceAvailable(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRSP_1_16_0.version)
        {
            Bool result = OVRSP_1_16_0.ovrp_IsCameraDeviceAvailable(cameraDevice);
            return result == Bool.True;
        }
        else
        {
    ...
    public static bool SetCameraDevicePreferredColorFrameSize(CameraDevice cameraDevice, int width, int height)
    {
        ...
        if (version >= OVRSP_1_16_0.version)
        {
            ...
            size.w = width;
            size.h = height;
            Result result = OVRSP_1_16_0.ovrp_SetCameraDevicePreferredColorFrameSize(cameraDevice, size);
            if (result != Result.Success)
            {
    ...
    public static bool OpenCameraDevice(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRSP_1_16_0.version)
        {
            Result result = OVRSP_1_16_0.ovrp_OpenCameraDevice(cameraDevice);
            if (result != Result.Success)
            {
    ...
    public static bool CloseCameraDevice(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRSP_1_16_0.version)
        {
            Result result = OVRSP_1_16_0.ovrp_CloseCameraDevice(cameraDevice);
            if (result != Result.Success)
            {
                //Debug.LogWarning("ovrp_OpenCameraDevice return " + result);
            }
    ...
    public static bool HasCameraDeviceOpened(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRSP_1_16_0.version)
        {
            Bool result = OVRSP_1_16_0.ovrp_HasCameraDeviceOpened(cameraDevice);
            return result == Bool.True;
        }
        else
        {
    ...
    public static bool IsCameraDeviceColorFrameAvailable(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRSP_1_16_0.version)
        {
            Bool result = OVRSP_1_16_0.ovrp_IsCameraDeviceColorFrameAvailable(cameraDevice);
            return result == Bool.True;
        }
        else
        {
    ...
    public static Texture2D GetCameraDeviceColorFrameTexture(CameraDevice cameraDevice)
    {
        ...
        {
            Sizei size = new Sizei();
            Result result = OVRSP_1_16_0.ovrp_GetCameraDeviceColorFrameSize(cameraDevice, out size);
            if (result != Result.Success)
            {
            ...
            IntPtr pixels;
            int rowPitch;
            result = OVRSP_1_16_0.ovrp_GetCameraDeviceColorFrameBgraPixels(cameraDevice, out pixels, out rowPitch);
            if (result != Result.Success)
            {
    ...
    public static bool DoesCameraDeviceSupportDepth(CameraDevice cameraDevice)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_17_0.version)
        {
            Bool supportDepth;
            Result result = OVRSP_1_17_0.ovrp_DoesCameraDeviceSupportDepth(cameraDevice, out supportDepth);
        ...
        CameraDeviceDepthSensingMode depthSensoringMode)
    {
        ...
        if (version >= OVRSP_1_17_0.version)
        {
            Result result = OVRSP_1_17_0.ovrp_SetCameraDeviceDepthSensingMode(camera, depthSensoringMode);
            return result == Result.Success;
        }
        else
        {
    ...
    public static bool SetCameraDevicePreferredDepthQuality(CameraDevice camera, CameraDeviceDepthQuality depthQuality)
    {
        ...
        if (version >= OVRSP_1_17_0.version)
        {
            Result result = OVRSP_1_17_0.ovrp_SetCameraDevicePreferredDepthQuality(camera, depthQuality);
            return result == Result.Success;
        }
        else
        {
    ...
    public static bool IsCameraDeviceDepthFrameAvailable(CameraDevice cameraDevice)
    {
        ...
        {
            Bool available;
            Result result = OVRSP_1_17_0.ovrp_IsCameraDeviceDepthFrameAvailable(cameraDevice, out available);
    ...
    public static Texture2D GetCameraDeviceDepthFrameTexture(CameraDevice cameraDevice)
    {
        ...
        {
            Sizei size = new Sizei();
            Result result = OVRSP_1_17_0.ovrp_GetCameraDeviceDepthFrameSize(cameraDevice, out size);
            if (result != Result.Success)
            {
            ...
            IntPtr depthData;
            int rowPitch;
            result = OVRSP_1_17_0.ovrp_GetCameraDeviceDepthFramePixels(cameraDevice, out depthData, out rowPitch);
            if (result != Result.Success)
            {
    ...
    public static Texture2D GetCameraDeviceDepthConfidenceTexture(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRSP_1_17_0.version)
        {
            ...
            int rowPitch;
            result = OVRSP_1_17_0.ovrp_GetCameraDeviceDepthConfidencePixels(cameraDevice, out confidenceData,
                out rowPitch);
            if (result != Result.Success)
            {
    ...
    public static bool eyeTrackedFoveatedRenderingSupported
    {
        get
        {
            ...
            {
                Bool supported;
                Result result = OVRSP_1_78_0.ovrp_GetFoveationEyeTrackedSupported(out supported);
                if (result != Result.Success)
                {
    ...
    public static bool eyeTrackedFoveatedRenderingEnabled
    {
        get
        {
            ...
            return false;
#else
            if (version >= OVRSP_1_78_0.version && eyeTrackedFoveatedRenderingSupported)
            {
                Bool enabled;
                Result result = OVRSP_1_78_0.ovrp_GetFoveationEyeTracked(out enabled);
                if (result != Result.Success)
                {
        ...
        set
        {
            ...
            if (version >= OVRSP_1_78_0.version && eyeTrackedFoveatedRenderingSupported)
            {
                Result result = OVRSP_1_78_0.ovrp_SetFoveationEyeTracked(value ? Bool.True : Bool.False);
                if (result != Result.Success)
                {
    ...
    public static bool fixedFoveatedRenderingSupported
    {
        get
        {
            ...
            {
                Bool supported;
                Result result = OVRSP_1_21_0.ovrp_GetTiledMultiResSupported(out supported);
                if (result == Result.Success)
                {
                    return supported == Bool.True;
                }
    ...
    public static FoveatedRenderingLevel foveatedRenderingLevel
    {
...
#else
            if (version >= OVRSP_1_21_0.version && foveatedRenderingSupported)
            {
                FoveatedRenderingLevel level;
                Result result = OVRSP_1_21_0.ovrp_GetTiledMultiResLevel(out level);
                if (result != Result.Success)
                {
        ...
        set
        {
            ...
            if (version >= OVRSP_1_21_0.version && foveatedRenderingSupported)
            {
                ...
                Result result = OVRSP_1_21_0.ovrp_SetTiledMultiResLevel(value);
                if (result != Result.Success)
                {
    ...
    public static bool useDynamicFoveatedRendering
    {
        get
        {
            ...
            return false;
#else
            if (version >= OVRSP_1_46_0.version && foveatedRenderingSupported)
            {
                Bool isDynamic = Bool.False;
                Result result = OVRSP_1_46_0.ovrp_GetTiledMultiResDynamic(out isDynamic);
                if (result != Result.Success)
                {
        ...
        set
        {
            ...
            if (version >= OVRSP_1_46_0.version && foveatedRenderingSupported)
            {
                Result result = OVRSP_1_46_0.ovrp_SetTiledMultiResDynamic(value ? Bool.True : Bool.False);
                if (result != Result.Success)
                {
    ...
    public static bool gpuUtilSupported
    {
        get
        {
            ...
            {
                Bool supported;
                Result result = OVRSP_1_21_0.ovrp_GetGPUUtilSupported(out supported);
                if (result == Result.Success)
                {
                    return supported == Bool.True;
                }
    ...
    public static float gpuUtilLevel
    {
        get
        {
            ...
            return 0.0f;
#else
            if (version >= OVRSP_1_21_0.version && gpuUtilSupported)
            {
                float level;
                Result result = OVRSP_1_21_0.ovrp_GetGPUUtilLevel(out level);
                if (result == Result.Success)
                {
                    return level;
                }
...
#if !OVRSPLUGIN_UNSUPPORTED_PLATFORM
    private static OVRSNativeBuffer _nativeSystemDisplayFrequenciesAvailable = null;
        ...
        get
        {
            ...
            if (_cachedSystemDisplayFrequenciesAvailable == null)
            {
                ...
                if (version >= OVRSP_1_21_0.version)
                {
                    ...
                    Result result =
                        OVRSP_1_21_0.ovrp_GetSystemDisplayAvailableFrequencies(IntPtr.Zero, ref numFrequencies);
                    if (result == Result.Success)
                    {
                        if (numFrequencies > 0)
                        {
                            ...
                            _nativeSystemDisplayFrequenciesAvailable =
                                new OVRSNativeBuffer(sizeof(float) * maxNumElements);
                            result = OVRSP_1_21_0.ovrp_GetSystemDisplayAvailableFrequencies(
    ...
    public static float systemDisplayFrequency
    {
        get
        {
            ...
            if (version >= OVRSP_1_21_0.version)
            {
                ...
                Result result = OVRSP_1_21_0.ovrp_GetSystemDisplayFrequency2(out displayFrequency);
                if (result == Result.Success)
                {
            ...
            else if (version >= OVRSP_1_1_0.version)
            {
                return OVRSP_1_1_0.ovrp_GetSystemDisplayFrequency();
            }
            else
            {
                return 0.0f;
        ...
        set
        {
            ...
            if (version >= OVRSP_1_21_0.version)
            {
                OVRSP_1_21_0.ovrp_SetSystemDisplayFrequency(value);
            }
#endif
        }
    }
    ...
    public static bool eyeFovPremultipliedAlphaModeEnabled
    {
        get
        {
            ...
            if (version >= OVRSP_1_57_0.version)
            {
                OVRSP_1_57_0.ovrp_GetEyeFovPremultipliedAlphaMode(ref isEnabled);
            }
        ...
        set
        {
            ...
            if (version >= OVRSP_1_57_0.version)
            {
                OVRSP_1_57_0.ovrp_SetEyeFovPremultipliedAlphaMode(ToBool(value));
            }
#endif
        }
    }
    ...
    public static bool GetNodeFrustum2(Node nodeId, out Frustumf2 frustum)
    {
        ...
        if (version >= OVRSP_1_15_0.version)
        {
            Result result = OVRSP_1_15_0.ovrp_GetNodeFrustum2(nodeId, out frustum);
            if (result != Result.Success)
            {
                return false;
            }
    ...
    public static bool AsymmetricFovEnabled
    {
        get
        {
            ...
            if (version >= OVRSP_1_21_0.version)
            {
                ...
                Result result = OVRSP_1_21_0.ovrp_GetAppAsymmetricFov(out asymmetricFovEnabled);
    ...
    public static bool EyeTextureArrayEnabled
    {
        get
        {
            ...
            if (version >= OVRSP_1_15_0.version)
            {
                ...
                enabled = OVRSP_1_15_0.ovrp_GetEyeTextureArrayEnabled();
                return enabled == Bool.True;
            }
            else
            {
    ...
    public static bool localDimmingSupported
    {
        get
        {
            ...
            if (version >= OVRSP_1_78_0.version)
            {
                ...
                Result result = OVRSP_1_78_0.ovrp_GetLocalDimmingSupported(out supported);
                if (result == Result.Success)
                {
                    return supported == Bool.True;
                }
    ...
    public static bool localDimming
    {
        get
        {
            ...
            return false;
#else
            if (version >= OVRSP_1_78_0.version && localDimmingSupported)
            {
                Bool LocalDimmingEnabled = Bool.False;
                Result result = OVRSP_1_78_0.ovrp_GetLocalDimming(out LocalDimmingEnabled);
                if (result == Result.Success)
                {
        ...
        set
        {
            ...
            if (version >= OVRSP_1_78_0.version && localDimmingSupported)
            {
                Result result = OVRSP_1_78_0.ovrp_SetLocalDimming(value == true ? Bool.True : Bool.False);
            }
#endif
        }
    }
    ...
    public static Handedness GetDominantHand()
    {
        ...
        if (version >= OVRSP_1_28_0.version && OVRSP_1_28_0.ovrp_GetDominantHand(out dominantHand) == Result.Success)
        {
            return dominantHand;
        }
    ...
    {
#if OVRSPLUGIN_UNSUPPORTED_PLATFORM || OVRSPLUGIN_EDITOR_MOCK_ENABLED
        return false;
#else
        if (version >= OVRSP_1_30_0.version)
        {
            return OVRSP_1_30_0.ovrp_SendEvent2(name, param, source.Length == 0 ? "integration" : source) ==
                   Result.Success;
        }
        else if (version >= OVRSP_1_28_0.version)
        {
            return OVRSP_1_28_0.ovrp_SendEvent(name, param) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static bool SetHeadPoseModifier(ref Quatf relativeRotation, ref Vector3f relativeTranslation)
    {
        ...
        if (version >= OVRSP_1_29_0.version)
        {
            return OVRSP_1_29_0.ovrp_SetHeadPoseModifier(ref relativeRotation, ref relativeTranslation) ==
                   Result.Success;
        }
        else
        {
    ...
    public static bool GetHeadPoseModifier(out Quatf relativeRotation, out Vector3f relativeTranslation)
    {
        ...
        if (version >= OVRSP_1_29_0.version)
        {
            return OVRSP_1_29_0.ovrp_GetHeadPoseModifier(out relativeRotation, out relativeTranslation) ==
                   Result.Success;
        }
        else
        {
    ...
    public static bool IsPerfMetricsSupported(PerfMetrics perfMetrics)
    {
        ...
        {
            Bool isSupported;
            Result result = OVRSP_1_30_0.ovrp_IsPerfMetricsSupported(perfMetrics, out isSupported);
            if (result == Result.Success)
            {
    ...
    public static float? GetPerfMetricsFloat(PerfMetrics perfMetrics)
    {
        ...
        {
            float value;
            Result result = OVRSP_1_30_0.ovrp_GetPerfMetricsFloat(perfMetrics, out value);
            if (result == Result.Success)
            {
                return value;
            }
    ...
    public static int? GetPerfMetricsInt(PerfMetrics perfMetrics)
    {
        ...
        {
            int value;
            Result result = OVRSP_1_30_0.ovrp_GetPerfMetricsInt(perfMetrics, out value);
            if (result == Result.Success)
            {
                return value;
            }
    ...
    public static double GetTimeInSeconds()
    {
        ...
        return 0.0;
#else
        if (version >= OVRSP_1_31_0.version)
        {
            double value;
            Result result = OVRSP_1_31_0.ovrp_GetTimeInSeconds(out value);
            if (result == Result.Success)
            {
                return value;
            }
    ...
    public static bool SetColorScaleAndOffset(Vector4 colorScale, Vector4 colorOffset, bool applyToAllLayers)
    {
        ...
        if (version >= OVRSP_1_31_0.version)
        {
            ...
            return OVRSP_1_31_0.ovrp_SetColorScaleAndOffset(colorScale, colorOffset, ovrpApplyToAllLayers) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static bool AddCustomMetadata(string name, string param = "")
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_32_0.version)
        {
            return OVRSP_1_32_0.ovrp_AddCustomMetadata(name, param) == Result.Success;
        }
        else
        {
            return false;
    ...
    public class Media
    {
        ...
        public static bool Initialize()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                return OVRSP_1_38_0.ovrp_Media_Initialize() == Result.Success;
            }
            else
            {
                return false;
        ...
        public static bool Shutdown()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                return OVRSP_1_38_0.ovrp_Media_Shutdown() == Result.Success;
            }
            else
            {
                return false;
        ...
        public static bool GetInitialized()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                ...
                Result result = OVRSP_1_38_0.ovrp_Media_GetInitialized(out initialized);
                if (result == Result.Success)
                {
        ...
        public static bool Update()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                return OVRSP_1_38_0.ovrp_Media_Update() == Result.Success;
            }
            else
            {
                return false;
        ...
        public static MrcActivationMode GetMrcActivationMode()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                ...
                if (OVRSP_1_38_0.ovrp_Media_GetMrcActivationMode(out mode) == Result.Success)
                {
                    return mode;
                }
                else
        ...
        public static bool SetMrcActivationMode(MrcActivationMode mode)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                return OVRSP_1_38_0.ovrp_Media_SetMrcActivationMode(mode) == Result.Success;
            }
            else
            {
                return false;
        ...
        public static bool SetPlatformInitialized()
        {
            ...
            return false;
#else
            if (version >= OVRSP_1_54_0.version)
            {
                return OVRSP_1_54_0.ovrp_Media_SetPlatformInitialized() == Result.Success;
            }
            else
            {
                return false;
        ...
        public static PlatformCameraMode GetPlatformCameraMode()
        {
            ...
            if (version >= OVRSP_1_57_0.version)
            {
                ...
                if (OVRSP_1_57_0.ovrp_Media_GetPlatformCameraMode(out mode) == Result.Success)
                {
                    return mode;
                }
                else
        ...
        public static bool SetPlatformCameraMode(PlatformCameraMode mode)
        {
            ...
            if (version >= OVRSP_1_57_0.version)
            {
                return OVRSP_1_57_0.ovrp_Media_SetPlatformCameraMode(mode) == Result.Success;
            }
            else
            {
                return false;
        ...
        public static bool IsMrcEnabled()
        {
            ...
            {
                Bool b;
                if (OVRSP_1_38_0.ovrp_Media_IsMrcEnabled(out b) == Result.Success)
                {
        ...
        public static bool IsMrcActivated()
        {
            ...
            {
                Bool b;
                if (OVRSP_1_38_0.ovrp_Media_IsMrcActivated(out b) == Result.Success)
                {
                    return b == Bool.True ? true : false;
                }
                else
        ...
        public static bool UseMrcDebugCamera()
        {
            ...
            {
                Bool b;
                if (OVRSP_1_38_0.ovrp_Media_UseMrcDebugCamera(out b) == Result.Success)
                {
                    return b == Bool.True ? true : false;
                }
                else
        ...
        public static bool SetMrcInputVideoBufferType(InputVideoBufferType videoBufferType)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                if (OVRSP_1_38_0.ovrp_Media_SetMrcInputVideoBufferType(videoBufferType) == Result.Success)
                {
                    return true;
                }
                else
        ...
        public static InputVideoBufferType GetMrcInputVideoBufferType()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                ...
                OVRSP_1_38_0.ovrp_Media_GetMrcInputVideoBufferType(ref videoBufferType);
        ...
        public static bool SetMrcFrameSize(int frameWidth, int frameHeight)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                if (OVRSP_1_38_0.ovrp_Media_SetMrcFrameSize(frameWidth, frameHeight) == Result.Success)
                {
                    return true;
                }
                else
        ...
        public static void GetMrcFrameSize(out int frameWidth, out int frameHeight)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                OVRSP_1_38_0.ovrp_Media_GetMrcFrameSize(ref frameWidth, ref frameHeight);
            }
#endif
        }
        ...
        public static bool SetMrcAudioSampleRate(int sampleRate)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                if (OVRSP_1_38_0.ovrp_Media_SetMrcAudioSampleRate(sampleRate) == Result.Success)
                {
                    return true;
                }
                else
        ...
        public static int GetMrcAudioSampleRate()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                OVRSP_1_38_0.ovrp_Media_GetMrcAudioSampleRate(ref sampleRate);
            }
        ...
        public static bool SetMrcFrameImageFlipped(bool imageFlipped)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                ...
                if (OVRSP_1_38_0.ovrp_Media_SetMrcFrameImageFlipped(flipped) == Result.Success)
                {
                    return true;
                }
                else
        ...
        public static bool GetMrcFrameImageFlipped()
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                OVRSP_1_38_0.ovrp_Media_GetMrcFrameImageFlipped(ref flipped);
            }
            ...
            int audioFrames, int audioChannels, double timestamp, double poseTime, ref int outSyncId)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                ...
                {
                    if (version >= OVRSP_1_49_0.version)
                    {
                        result = OVRSP_1_49_0.ovrp_Media_EncodeMrcFrameWithPoseTime(textureHandle, audioDataPtr,
                            audioDataLen, audioChannels, timestamp, poseTime, ref outSyncId);
                    }
                    else
                    {
                        result = OVRSP_1_38_0.ovrp_Media_EncodeMrcFrame(textureHandle, audioDataPtr, audioDataLen,
                ...
                else
                {
                    if (version >= OVRSP_1_49_0.version)
                    {
                        result = OVRSP_1_49_0.ovrp_Media_EncodeMrcFrameDualTexturesWithPoseTime(textureHandle,
                            fgTextureHandle, audioDataPtr, audioDataLen, audioChannels, timestamp, poseTime,
                            ref outSyncId);
                    }
                    else
                    {
                        result = OVRSP_1_38_0.ovrp_Media_EncodeMrcFrameWithDualTextures(textureHandle, fgTextureHandle,
            ...
            double timestamp, double poseTime, ref int outSyncId)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                ...
                if (version >= OVRSP_1_49_0.version)
                {
                    result = OVRSP_1_49_0.ovrp_Media_EncodeMrcFrameWithPoseTime(pointer, audioDataPtr, audioDataLen,
                        audioChannels, timestamp, poseTime, ref outSyncId);
                }
                else
                {
                    result = OVRSP_1_38_0.ovrp_Media_EncodeMrcFrame(pointer, audioDataPtr, audioDataLen, audioChannels,
        ...
        public static bool SyncMrcFrame(int syncId)
        {
            ...
            if (version >= OVRSP_1_38_0.version)
            {
                return OVRSP_1_38_0.ovrp_Media_SyncMrcFrame(syncId) == Result.Success;
            }
            else
            {
                return false;
        ...
        public static bool SetAvailableQueueIndexVulkan(uint queueIndexVk)
        {
            ...
            return false;
#else
            if (version >= OVRSP_1_45_0.version)
            {
                return OVRSP_1_45_0.ovrp_Media_SetAvailableQueueIndexVulkan(queueIndexVk) == Result.Success;
            }
            else
            {
                return false;
            ...
            Posef rightControllerPose)
        {
            ...
            if (version >= OVRSP_1_49_0.version)
            {
                Result res = OVRSP_1_49_0.ovrp_Media_SetHeadsetControllerPose(headsetPose,
        ...
        public static bool IsCastingToRemoteClient()
        {
            ...
            if (version >= OVRSP_1_66_0.version)
            {
                ...
                Result result = OVRSP_1_66_0.ovrp_Media_IsCastingToRemoteClient(out isCasting);
                if (result == Result.Success)
                {
    ...
    public static bool SetDeveloperMode(Bool active)
    {
        ...
        if (version >= OVRSP_1_38_0.version)
        {
            return OVRSP_1_38_0.ovrp_SetDeveloperMode(active) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static float GetAdaptiveGPUPerformanceScale()
    {
        ...
        return 1.0f;
#else
        if (version >= OVRSP_1_42_0.version)
        {
            float adaptiveScale = 1.0f;
            if (OVRSP_1_42_0.ovrp_GetAdaptiveGpuPerformanceScale2(ref adaptiveScale) == Result.Success)
            {
    ...
    public static bool GetHandTrackingEnabled()
    {
        ...
        if (version >= OVRSP_1_44_0.version)
        {
            Bool val = OVRSPlugin.Bool.False;
            Result res = OVRSP_1_44_0.ovrp_GetHandTrackingEnabled(ref val);
            if (res == Result.Success)
            {
                return val == OVRSPlugin.Bool.True;
            }
    ...
    public static OVRSHandSkeletonVersion HandSkeletonVersion { get; private set; } = OVRSHandSkeletonVersion.OVRS;
    ...
    public static bool GetHandState(Step stepId, Hand hand, ref HandState handState)
    {
        ...
        if (version >= OVRSP_1_103_0.version && HandSkeletonVersion == OVRSHandSkeletonVersion.OpenXR)
        {
            Result res = Result.Failure;
            res = OVRSP_1_103_0.ovrp_GetHandState3(stepId, -1, hand, out cachedHandState3);
        ...
        if (version >= OVRSP_1_44_0.version)
        {
            Result res = OVRSP_1_44_0.ovrp_GetHandState(stepId, hand, out cachedHandState);
            if (res == Result.Success)
            {
                // attempt to avoid allocations if client provides appropriately pre-initialized HandState
                if (handState.BoneRotations == null ||
    ...
    public static bool GetHandTrackingState(Step stepId, Hand hand, ref HandTrackingState handTrackingState)
    {
        ...
        if (version < OVRSP_1_81_0.version)
        {
            return false;
        }

        Result res = OVRSP_1_106_0.ovrp_GetHandTrackingState(stepId, -1, hand, out cachedHandTrackingState);
        if (res != Result.Success)
        {
            return false;
        }

        if (version >= OVRSP_1_106_0.version)
        {
    ...
    public static bool GetSkeleton(SkeletonType skeletonType, out Skeleton skeleton)
    {
        ...
        if (version >= OVRSP_1_44_0.version)
        {
            return OVRSP_1_44_0.ovrp_GetSkeleton(skeletonType, out skeleton) == Result.Success;
        }
        else
        {
            skeleton = default(Skeleton);
    ...
    public static bool GetSkeleton2(SkeletonType skeletonType, ref Skeleton2 skeleton)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_92_0.version)
        {
            SkeletonType globalSkeletonType = skeletonType;
            if (OVRSSkeleton.IsBodySkeleton((OVRSSkeleton.SkeletonType)skeletonType))
            {
                switch (_currentJointSet)
                {
                    ...
                    case BodyJointSet.None:
                        Debug.LogError("Global joint set is invalid. Ensure that there is an " +
                            "OVRSBody instance that is active an enabled with a valid joint set");
                        return false;
                }
            }

            Result res = OVRSP_1_92_0.ovrp_GetSkeleton3(globalSkeletonType, out cachedSkeleton3);
            if (res == Result.Success)
            {
        ...
        else if (version >= OVRSP_1_55_0.version)
        {
            Result res = OVRSP_1_55_0.ovrp_GetSkeleton2(skeletonType, out cachedSkeleton2);
            if (res == Result.Success)
            {
    ...
    public static bool bodyTrackingSupported =>
        ...
        false;
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_GetBodyTrackingSupported(out var value) == Result.Success &&
        value == Bool.True;
#endif
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_GetBodyTrackingEnabled(out var value) == Result.Success &&
        value == Bool.True;
#endif
    ...
    public static bool GetBodyState(Step stepId, ref BodyState bodyState)
    {
        ...
        if (version < OVRSP_1_78_0.version) return false;
        ...
        var result = OVRSP_1_78_0.ovrp_GetBodyState(stepId, -1, out var bodyStateInternal);
    ...
    public static bool GetBodyState4(Step stepId, BodyJointSet jointSet, ref BodyState bodyState)
    {
        ...
        if (version >= OVRSP_1_92_0.version)
        {
            ...
            var result = OVRSP_1_92_0.ovrp_GetBodyState4(stepId, -1, out var bodyState4Internal);
    ...
    public static bool GetMesh(MeshType meshType, out Mesh mesh)
    {
        ...
        if (version >= OVRSP_1_44_0.version)
        {
            ...
            Result result = OVRSP_1_44_0.ovrp_GetMesh((OVRSPlugin.MeshType)meshType, meshPtr);
            if (result == Result.Success)
            {
    ...
    public static bool StartKeyboardTracking(UInt64 trackedKeyboardId)
    {
        ...
        {
            Result result;
            result = OVRSP_1_68_0.ovrp_StartKeyboardTracking(trackedKeyboardId);
            return result == Result.Success;
        }
        else
        {
    ...
    public static bool StopKeyboardTracking()
    {
        ...
        {
            Result result;
            result = OVRSP_1_68_0.ovrp_StopKeyboardTracking();
            return result == Result.Success;
        }
        else
        {
    ...
    public static bool GetKeyboardState(Step stepId, out KeyboardState keyboardState)
    {
        ...
        {
            Result result;
            result = OVRSP_1_68_0.ovrp_GetKeyboardState(stepId, -1, out keyboardState);
            return result == Result.Success;
        }
        else
        {
        ...
        out KeyboardDescription keyboardDescription)
    {
        ...
        {
            Result result;
            result = OVRSP_1_68_0.ovrp_GetSystemKeyboardDescription(keyboardQueryFlags, out keyboardDescription);
            return result == Result.Success;
        }
        else
        {
    ...
    public static Result CreateVirtualKeyboard(VirtualKeyboardCreateInfo createInfo)
    {
        ...
        return Result.Failure_Unsupported;
#else
        if (version >= OVRSP_1_74_0.version)
        {
            return OVRSP_1_74_0.ovrp_CreateVirtualKeyboard(createInfo);
        }
    ...
    public static Result DestroyVirtualKeyboard()
    {
        ...
        if (version >= OVRSP_1_74_0.version)
        {
            return OVRSP_1_74_0.ovrp_DestroyVirtualKeyboard();
        }
    ...
    public static Result SendVirtualKeyboardInput(VirtualKeyboardInputInfo inputInfo, ref Posef interactorRootPose)
    {
        ...
        if (version >= OVRSP_1_74_0.version)
        {
            return OVRSP_1_74_0.ovrp_SendVirtualKeyboardInput(inputInfo, ref interactorRootPose);
        }
    ...
    public static Result ChangeVirtualKeyboardTextContext(string textContext)
    {
        ...
        if (version >= OVRSP_1_74_0.version)
        {
            return OVRSP_1_74_0.ovrp_ChangeVirtualKeyboardTextContext(textContext);
        }
    ...
    public static Result CreateVirtualKeyboardSpace(VirtualKeyboardSpaceCreateInfo createInfo, out UInt64 keyboardSpace)
    {
        ...
        if (version >= OVRSP_1_74_0.version)
        {
            return OVRSP_1_74_0.ovrp_CreateVirtualKeyboardSpace(createInfo, out keyboardSpace);
        }
    ...
    public static Result SuggestVirtualKeyboardLocation(VirtualKeyboardLocationInfo locationInfo)
    {
        ...
        if (version >= OVRSP_1_74_0.version)
        {
            return OVRSP_1_74_0.ovrp_SuggestVirtualKeyboardLocation(locationInfo);
        }
    ...
    public static Result GetVirtualKeyboardScale(out float scale)
    {
        ...
        if (version >= OVRSP_1_74_0.version)
        {
            return OVRSP_1_74_0.ovrp_GetVirtualKeyboardScale(out scale);
        }
        ...
        VirtualKeyboardModelAnimationStateHandler stateHandler)
    {
        ...
        if (version >= OVRSP_1_83_0.version)
        {
            ...
            var result = OVRSP_1_83_0.ovrp_GetVirtualKeyboardModelAnimationStates(ref animationStatesInternal);
            if (result != Result.Success)
            {
            ...
            result = OVRSP_1_83_0.ovrp_GetVirtualKeyboardModelAnimationStates(ref animationStatesInternal);
            if (result != Result.Success)
            {
    ...
    public static Result GetVirtualKeyboardDirtyTextures(out VirtualKeyboardTextureIds textureIds)
    {
        ...
        if (version >= OVRSP_1_83_0.version)
        {
            ...
            var result = OVRSP_1_83_0.ovrp_GetVirtualKeyboardDirtyTextures(ref textureIdsInternal);
            ...
            try
            {
                ...
                result = OVRSP_1_83_0.ovrp_GetVirtualKeyboardDirtyTextures(ref textureIdsInternal);
                if (result != Result.Success)
                {
    ...
    public static Result GetVirtualKeyboardTextureData(UInt64 textureId, ref VirtualKeyboardTextureData textureData)
    {
        ...
        if (version >= OVRSP_1_83_0.version)
        {
            return OVRSP_1_83_0.ovrp_GetVirtualKeyboardTextureData(textureId, ref textureData);
        }
    ...
    public static Result SetVirtualKeyboardModelVisibility(ref VirtualKeyboardModelVisibility visibility)
    {
        ...
        if (version >= OVRSP_1_83_0.version)
        {
            return OVRSP_1_83_0.ovrp_SetVirtualKeyboardModelVisibility(ref visibility);
        }
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_GetFaceTrackingEnabled(out var val) == Result.Success &&
        val == Bool.True;
#endif
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_GetFaceTrackingSupported(out var value) == Result.Success &&
        value == Bool.True;
#endif //OVRSPLUGIN_UNSUPPORTED_PLATFORM
    ...
    {
        Result res = OVRSP_1_78_0.ovrp_GetFaceState(stepId, frameIndex, out cachedFaceState);
        if (res != Result.Success)
        {
            return false;
        }
    ...
    public static bool GetFaceState2(Step stepId, int frameIndex, ref FaceState faceState)
    {
        ...
        if (version >= OVRSP_1_92_0.version)
        {
            Result res = OVRSP_1_92_0.ovrp_GetFaceState2(stepId, frameIndex, out cachedFaceState2);
            if (res != Result.Success)
            {
                return false;
            }
    ...
    public static OVRSPlugin.Result GetFaceVisemesState(Step stepId, ref FaceVisemesState faceVisemesState)
    {
#if OVRSPLUGIN_UNSUPPORTED_PLATFORM
        return OVRSPlugin.Result.Failure_Unsupported;
#else
        if (version >= OVRSP_1_104_0.version)
        {
            Result res = OVRSP_1_104_0.ovrp_GetFaceVisemesState(stepId, -1 /*OVRSP_CURRENT_FRAMEINDEX*//*, out cachedFaceVisemesState);
            if (res != Result.Success)
            {
                return res;
            }
            ...
            return OVRSPlugin.Result.Success;
        }
    ...
    public static OVRSPlugin.Result SetFaceTrackingVisemesEnabled(bool enabled)
    {
#if OVRSPLUGIN_UNSUPPORTED_PLATFORM
        return OVRSPlugin.Result.Failure_Unsupported;
#else
        if (version >= OVRSP_1_104_0.version)
        {
            return OVRSP_1_104_0.ovrp_SetFaceTrackingVisemesEnabled(enabled ? Bool.True : Bool.False);
        }
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_GetEyeTrackingEnabled(out var val) == Result.Success &&
        val == Bool.True;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_GetEyeTrackingSupported(out var val) == Result.Success &&
        val == Bool.True;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    ...
    public static bool GetEyeGazesState(Step stepId, int frameIndex, ref EyeGazesState eyeGazesState)
    {
        ...
        if (version >= OVRSP_1_78_0.version)
        {
            Result res = OVRSP_1_78_0.ovrp_GetEyeGazesState(stepId, frameIndex, out cachedEyeGazesState);
            if (res == Result.Success)
            {
                // attempt to avoid allocations if client provides appropriately pre-initialized HandState
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_StartEyeTracking() == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_StopEyeTracking() == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_StartFaceTracking() == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_StopFaceTracking() == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    ...
    public static bool faceTracking2Enabled =>
        ...
        false;
#else
        version >= OVRSP_1_92_0.version &&
        OVRSP_1_92_0.ovrp_GetFaceTracking2Enabled(out var val) == Result.Success &&
        val == Bool.True;
#endif
...
#else
        version >= OVRSP_1_92_0.version &&
        OVRSP_1_92_0.ovrp_GetFaceTracking2Supported(out var value) == Result.Success &&
        value == Bool.True;
#endif //OVRSPLUGIN_UNSUPPORTED_PLATFORM
    ...
    public static bool faceTrackingVisemesSupported =>
        ...
        false;
#else
        version >= OVRSP_1_104_0.version &&
        OVRSP_1_104_0.ovrp_GetFaceTrackingVisemesSupported(out var value) == Result.Success &&
        value == Bool.True;
#endif //OVRSPLUGIN_UNSUPPORTED_PLATFORM
...
#else
        version >= OVRSP_1_92_0.version &&
        OVRSP_1_92_0.ovrp_StartFaceTracking2(requestedFaceTrackingDataSources, (uint)(requestedFaceTrackingDataSources?.Length ?? 0)) == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
...
#else
        version >= OVRSP_1_92_0.version &&
        OVRSP_1_92_0.ovrp_StopFaceTracking2() == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    ...
    public static bool StartBodyTracking2(BodyJointSet jointSet)
    {
        ...
        if (version >= OVRSP_1_92_0.version)
        {
            ...
            if (OVRSP_1_92_0.ovrp_StartBodyTracking2(jointSet) == Result.Success)
            {
        ...
        {
            Debug.LogError("Full body joint set is not supported by this version of OVRSPlugin.");
            return false;
        }
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
...
#else
        version >= OVRSP_1_78_0.version &&
        OVRSP_1_78_0.ovrp_StartBodyTracking() == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    ...
    public static bool RequestBodyTrackingFidelity(BodyTrackingFidelity2 fidelity) =>
        ...
        false;
#else
        version >= OVRSP_1_92_0.version && OVRSP_1_92_0.ovrp_RequestBodyTrackingFidelity(fidelity) == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM


    public static bool SuggestBodyTrackingCalibrationOverride(BodyTrackingCalibrationInfo calibrationInfo) =>
#if OVRSPUGIN_UNSUPPORTED_PLATFORM
        false;
#else
        version >= OVRSP_1_92_0.version && OVRSP_1_92_0.ovrp_SuggestBodyTrackingCalibrationOverride(calibrationInfo) == Result.Success;
#endif // OVRSPUGIN_UNSUPPORTED_PLATFORM
    public static bool ResetBodyTrackingCalibration() =>
#if OVRSPUGIN_UNSUPPORTED_PLATFORM
        false;
#else
        version >= OVRSP_1_92_0.version && OVRSP_1_92_0.ovrp_ResetBodyTrackingCalibration() == Result.Success;
#endif // OVRSPUGIN_UNSUPPORTED_PLATFORM
    ...
    public static bool StopBodyTracking()
    {
        ...
        return version >= OVRSP_1_78_0.version &&
            OVRSP_1_78_0.ovrp_StopBodyTracking() == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
    ...
    public static int GetLocalTrackingSpaceRecenterCount()
    {
        ...
        {
            int recenterCount = 0;
            Result res = OVRSP_1_44_0.ovrp_GetLocalTrackingSpaceRecenterCount(ref recenterCount);
            if (res == Result.Success)
            {
    ...
    public static bool GetSystemHmd3DofModeEnabled()
    {
        ...
        {
            Bool val = Bool.False;
            Result res = OVRSP_1_45_0.ovrp_GetSystemHmd3DofModeEnabled(ref val);
            if (res == Result.Success)
            {
    ...
    public static bool SetClientColorDesc(ColorSpace colorSpace)
    {
        ...
        if (version >= OVRSP_1_49_0.version)
        {
            ...
            return OVRSP_1_49_0.ovrp_SetClientColorDesc(colorSpace) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static ColorSpace GetHmdColorDesc()
    {
        ...
        if (version >= OVRSP_1_49_0.version)
        {
            Result res = OVRSP_1_49_0.ovrp_GetHmdColorDesc(ref colorSpace);
            if (res != Result.Success)
            {
        ...
        {
            Debug.LogError("GetHmdColorDesc: Not supported on this version of OVRSPlugin");
            return colorSpace;
        }
#endif
    }
    ...
    public static bool PollEvent(ref EventDataBuffer eventDataBuffer)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_55_1.version)
        {
            ...
            Result result = OVRSP_1_55_1.ovrp_PollEvent2(ref eventDataBuffer.EventType, ref DataPtr);
        ...
        {
            return OVRSP_1_55_0.ovrp_PollEvent(ref eventDataBuffer) == Result.Success;
        }
        else
        {
            eventDataBuffer = default(EventDataBuffer);
    ...
    public static UInt64 GetNativeOpenXRInstance()
    {
        ...
        if (version >= OVRSP_1_55_0.version)
        {
            ...
            if (OVRSP_1_55_0.ovrp_GetNativeOpenXRHandles(out instance, out session) == Result.Success)
            {
                return instance;
            }
        }
    ...
    public static bool SetKeyboardOverlayUV(Vector2f uv)
    {
        ...
        if (version >= OVRSP_1_57_0.version)
        {
            Result result = OVRSP_1_57_0.ovrp_SetKeyboardOverlayUV(uv);
            return (result == Result.Success);
        }
        else
        {
    ...
    public static bool CreateSpatialAnchor(SpatialAnchorCreateInfo createInfo, out UInt64 requestId)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_72_0.version)
        {
            Result result = OVRSP_1_72_0.ovrp_CreateSpatialAnchor(ref createInfo, out requestId);
            return (result == Result.Success);
        }
        else
        {
        ...
        )
    {
        ...
        return version >= OVRSP_1_72_0.version
               && OVRSP_1_72_0.ovrp_SetSpaceComponentStatus(ref space, componentType, ToBool(enable), timeout,
        ...
        out bool enabled, out bool changePending)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            ...
            Result result =
                OVRSP_1_72_0.ovrp_GetSpaceComponentStatus(ref space, componentType, out isEnabled, out isPending);
        ...
        SpaceComponentType[] supportedComponents)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            Result result = OVRSP_1_72_0.ovrp_EnumerateSpaceSupportedComponents(ref space,
        ...
        SpaceComponentType* buffer)
    {
        ...
        return version < OVRSP_1_72_0.version
            ...
            : OVRSP_1_72_0.ovrp_EnumerateSpaceSupportedComponents(ref space, capacityInput, out countOutput, buffer);
#endif
    }
        ...
        out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            return OVRSP_1_72_0.ovrp_SaveSpace(ref space, location, mode, out requestId) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static Result EraseSpaceWithResult(UInt64 space, SpaceStorageLocation location, out UInt64 requestId)
    {
        ...
        return version >= OVRSP_1_72_0.version
            ? OVRSP_1_72_0.ovrp_EraseSpace(ref space, location, out requestId)
            : Result.Failure_Unsupported;
#endif
    }
    ...
    public static bool GetSpaceUuid(UInt64 space, out Guid uuid)
    {
        ...
        return false;
#else
        return version >= OVRSP_1_74_0.version &&
               OVRSP_1_74_0.ovrp_GetSpaceUuid(in space, out uuid) == Result.Success;
#endif
    }
    ...
    public static Result QuerySpacesWithResult(SpaceQueryInfo queryInfo, out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            ...
            return OVRSP_1_72_0.ovrp_QuerySpaces(ref queryInfo, out requestId);
        }
        else
        {
    ...
    public static Result QuerySpaces2(SpaceQueryInfo2 queryInfo, out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_103_0.version)
        {
            ...
            return OVRSP_1_103_0.ovrp_QuerySpaces2(ref queryInfo, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
        ...
        out NativeArray<SpaceQueryResult> results, Allocator allocator)
    {
        ...
        if (version < OVRSP_1_72_0.version) return false;

        uint count = 0;
        if (OVRSP_1_72_0.ovrp_RetrieveSpaceQueryResults(ref requestId, default,
        ...
        if (OVRSP_1_72_0.ovrp_RetrieveSpaceQueryResults(ref requestId,
    ...
    public static bool RetrieveSpaceQueryResults(UInt64 requestId, out SpaceQueryResult[] results)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            ...
            result = OVRSP_1_72_0.ovrp_RetrieveSpaceQueryResults(ref requestId, 0, ref resultCountOutput,
                nullResultsPtr);
            if (result != Result.Success)
            {
                return false;
            ...
            result = OVRSP_1_72_0.ovrp_RetrieveSpaceQueryResults(ref requestId, resultCountOutput, ref resultCountOutput,
                resultsPtr);
            if (result != Result.Success)
            {
        ...
        out ulong requestId)
    {
        ...
        return Result.Failure_Unsupported;
#else
        return version >= OVRSP_1_79_0.version
            ? OVRSP_1_79_0.ovrp_SaveSpaceList(spaces, numSpaces, location, out requestId)
            : Result.Failure_Unsupported;
#endif
    }
...
#else
        return version >= OVRSP_1_79_0.version &&
               OVRSP_1_79_0.ovrp_GetSpaceUserId(in spaceUserHandle, out spaceUserId) == Result.Success;
#endif
    }
...
#else
        return version >= OVRSP_1_79_0.version &&
               OVRSP_1_79_0.ovrp_CreateSpaceUser(in spaceUserId, out spaceUserHandle) == Result.Success;
#endif
    }
...
#else
        return version >= OVRSP_1_79_0.version &&
               OVRSP_1_79_0.ovrp_DestroySpaceUser(in spaceUserHandle) == Result.Success;
#endif
    }
        ...
        out ulong requestId)
    {
        ...
        return Result.Failure_Unsupported;
#else
        if (version >= OVRSP_1_79_0.version)
        {
            return OVRSP_1_79_0.ovrp_ShareSpaces(spaces, numSpaces, userHandles, numUsers, out requestId);
        }
        else
        {
            return Result.Failure_Unsupported;
    ...
    {
        using var profiler = new OVRSProfilerScope(nameof(TryLocateSpace));

        pose = Posef.identity;
#if OVRSPLUGIN_UNSUPPORTED_PLATFORM
        return false;
#else
        return version >= OVRSP_1_64_0.version &&
               OVRSP_1_64_0.ovrp_LocateSpace(ref pose, ref space, baseOrigin) == Result.Success;
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
...
#else
        if (version >= OVRSP_1_79_0.version &&
            OVRSP_1_79_0.ovrp_LocateSpace2(out var spaceLocation, in space, baseOrigin) ==
            Result.Success)
        {
    ...
    public static bool DestroySpace(UInt64 space)
    {
        ...
        return false;
#else
        if (version >= OVRSP_1_65_0.version)
        {
            Result result = OVRSP_1_65_0.ovrp_DestroySpace(ref space);
            return (result == Result.Success);
        }
        else
        {
    ...
    public static bool GetSpaceContainer(UInt64 space, out Guid[] containerUuids)
    {
        ...
        if (OVRSP_1_72_0.ovrp_GetSpaceContainer(ref space, ref containerInternal) != Result.Success) return false;
    ...
    public static bool GetSpaceBoundingBox2D(UInt64 space, out Rectf rect)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            Result result = OVRSP_1_72_0.ovrp_GetSpaceBoundingBox2D(ref space, out rect);
            return (result == Result.Success);
        }
        else
        {
    ...
    public static bool GetSpaceBoundingBox3D(UInt64 space, out Boundsf bounds)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            Result result = OVRSP_1_72_0.ovrp_GetSpaceBoundingBox3D(ref space, out bounds);
            return (result == Result.Success);
        }
        else
        {
    ...
    internal static unsafe bool GetSpaceSemanticLabelsNonAlloc(UInt64 space, ref char[] buffer, out int length)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            ...
            Result result = OVRSP_1_72_0.ovrp_GetSpaceSemanticLabels(ref space, ref labelsInternal);
            if (result == Result.Success)
            {
                ...
                result = OVRSP_1_72_0.ovrp_GetSpaceSemanticLabels(ref space, ref labelsInternal);
    ...
    public static bool GetSpaceRoomLayout(UInt64 space, out RoomLayout roomLayout)
    {
        ...
        if (OVRSP_1_72_0.ovrp_GetSpaceRoomLayout(ref space, ref roomLayoutInternal) != Result.Success) return false;
    ...
    public static bool GetSpaceBoundary2DCount(UInt64 space, out int count)
    {
        ...
        var result = OVRSP_1_72_0.ovrp_GetSpaceBoundary2D(ref space, ref boundaryInternal);
    ...
    public static unsafe bool GetSpaceBoundary2D(UInt64 space, NativeArray<Vector2> boundary, out int count)
    {
        ...
        var result = OVRSP_1_72_0.ovrp_GetSpaceBoundary2D(ref space, ref boundaryInternal) == Result.Success;
        count = boundaryInternal.vertexCountOutput;
        return result;
#endif
    }
    ...
    public static NativeArray<Vector2> GetSpaceBoundary2D(UInt64 space, Allocator allocator)
    {
        ...
        return default;
#else
        if (version < OVRSP_1_72_0.version) return default;
        ...
        if (OVRSP_1_72_0.ovrp_GetSpaceBoundary2D(ref space, ref boundaryInternal) == Result.Success)
        {
            return boundary;
        }
    ...
    public static bool GetSpaceBoundary2D(UInt64 space, out Vector2[] boundary)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            ...
            Result result = OVRSP_1_72_0.ovrp_GetSpaceBoundary2D(ref space, ref boundaryInternal);
            if (result == Result.Success)
            {
                ...
                result = OVRSP_1_72_0.ovrp_GetSpaceBoundary2D(ref space, ref boundaryInternal);
                if (result == Result.Success)
                {
    ...
    public static bool RequestSceneCapture(string requestString, out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_72_0.version)
        {
            ...
            Result result = OVRSP_1_72_0.ovrp_RequestSceneCapture(ref sceneCaptureRequest, out requestId);
            return (result == Result.Success);
        }
        else
        {
    ...
    public static bool GetSpaceTriangleMeshCounts(UInt64 space, out int vertexCount, out int triangleCount)
    {
        ...
        return false;
#else
        if (version < OVRSP_1_82_0.version) return false;

        using (new OVRSProfilerScope(nameof(GetSpaceTriangleMeshCounts)))
        {
            var triangleMeshInternal = default(TriangleMeshInternal);
            var result = OVRSP_1_82_0.ovrp_GetSpaceTriangleMesh(ref space, ref triangleMeshInternal);
        ...
        NativeArray<int> triangles)
    {
        ...
        using (new OVRSProfilerScope(nameof(GetSpaceTriangleMesh)))
        {
            ...
            return OVRSP_1_82_0.ovrp_GetSpaceTriangleMesh(ref space, ref triangleMeshInternal) == Result.Success;
        }
#endif
    }
    ...
    public static bool GetLayerRecommendedResolution(int layerId, out Sizei recommendedSize)
    {
        ...
        if (version >= OVRSP_1_84_0.version)
        {
            return OVRSP_1_84_0.ovrp_GetLayerRecommendedResolution(layerId, out recommendedSize) == Result.Success;
        }
    ...
    public static bool GetEyeLayerRecommendedResolution(out Sizei recommendedSize)
    {
        ...
        if (version >= OVRSP_1_84_0.version)
        {
            return OVRSP_1_84_0.ovrp_GetEyeLayerRecommendedResolution(out recommendedSize) == Result.Success;
        }
    ...
    public static string[] GetRenderModelPaths()
    {
        ...
        if (version >= OVRSP_1_68_0.version)
        {
            ...
            IntPtr pathPtr = Marshal.AllocHGlobal(sizeof(byte) * OVRSP_1_68_0.OVRSP_RENDER_MODEL_MAX_PATH_LENGTH);
            while (OVRSP_1_68_0.ovrp_GetRenderModelPaths(index, pathPtr) == Result.Success)
            {
    ...
    public static bool GetRenderModelProperties(string modelPath, ref RenderModelProperties modelProperties)
    {
        ...
        if (version >= OVRSP_1_74_0.version)
        {
            result = OVRSP_1_74_0.ovrp_GetRenderModelProperties2(
                modelPath,
                RenderModelFlags.SupportsGltf20Subset2,
                out props);
        }
        else if (version >= OVRSP_1_68_0.version)
        {
            result = OVRSP_1_68_0.ovrp_GetRenderModelProperties(modelPath, out props);
        }
        else
        {
            return false;
    ...
    public static byte[] LoadRenderModel(UInt64 modelKey)
    {
        ...
        {
            uint bufferSize = 0;
            if (OVRSP_1_68_0.ovrp_LoadRenderModel(modelKey, 0, ref bufferSize, IntPtr.Zero) != Result.Success)
            {
                return null;
            }
            ...
            if (OVRSP_1_68_0.ovrp_LoadRenderModel(modelKey, bufferSize, ref bufferSize, bufferPtr) != Result.Success)
            {
    ...
    public class Ktx
    {
        public static IntPtr LoadKtxFromMemory(IntPtr dataPtr, uint length)
        {
            ...
            if (version >= OVRSP_1_65_0.version)
            {
                ...
                OVRSP_1_65_0.ovrp_KtxLoadFromMemory(ref dataPtr, length, ref texture);
                return texture;
            }
        ...
        public static uint GetKtxTextureWidth(IntPtr texture)
        {
            ...
            {
                uint width = 0;
                OVRSP_1_65_0.ovrp_KtxTextureWidth(texture, ref width);
                return width;
            }
        ...
        public static uint GetKtxTextureHeight(IntPtr texture)
        {
            ...
            {
                uint height = 0;
                OVRSP_1_65_0.ovrp_KtxTextureHeight(texture, ref height);
                return height;
            }
        ...
        public static bool TranscodeKtxTexture(IntPtr texture, uint format)
        {
            ...
            if (version >= OVRSP_1_65_0.version)
            {
                return OVRSP_1_65_0.ovrp_KtxTranscode(texture, format) == Result.Success;
            }
        ...
        public static uint GetKtxTextureSize(IntPtr texture)
        {
            ...
            {
                uint size = 0;
                OVRSP_1_65_0.ovrp_KtxTextureSize(texture, ref size);
                return size;
            }
        ...
        public static bool GetKtxTextureData(IntPtr texture, IntPtr textureData, uint bufferSize)
        {
            ...
            if (version >= OVRSP_1_65_0.version)
            {
                return OVRSP_1_65_0.ovrp_KtxGetTextureData(texture, textureData, bufferSize) == Result.Success;
            }
        ...
        public static bool DestroyKtxTexture(IntPtr texture)
        {
            ...
            if (version >= OVRSP_1_65_0.version)
            {
                return OVRSP_1_65_0.ovrp_KtxDestroy(texture) == Result.Success;
            }
    ...
    public static Result StartColocationSessionAdvertisement(ColocationSessionStartAdvertisementInfo info, out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_103_0.version)
        {
            return OVRSP_1_103_0.ovrp_StartColocationAdvertisement(in info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result StopColocationSessionAdvertisement(out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_103_0.version)
        {
            return OVRSP_1_103_0.ovrp_StopColocationAdvertisement(out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result StartColocationSessionDiscovery(out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_103_0.version)
        {
            return OVRSP_1_103_0.ovrp_StartColocationDiscovery(out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result StopColocationSessionDiscovery(out UInt64 requestId)
    {
        ...
        if (version >= OVRSP_1_103_0.version)
        {
            return OVRSP_1_103_0.ovrp_StopColocationDiscovery(out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result ShareSpaces(in ShareSpacesInfo info, out ulong requestId)
    {
        ...
        if (version >= OVRSP_1_103_0.version)
        {
            return OVRSP_1_103_0.ovrp_ShareSpaces2(in info, out requestId);
        }
        else
        {
            return Result.Failure_NotYetImplemented;
    ...
    public static Result DiscoverSpaces(in SpaceDiscoveryInfo info, out ulong requestId)
    {
        ...
        return Result.Failure_Unsupported;
#else
        if (version < OVRSP_1_97_0.version) return Result.Failure_NotYetImplemented;
        return OVRSP_1_97_0.ovrp_DiscoverSpaces(in info, out requestId);
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
        ...
        int capacityInput, out int countOutput)
    {
        ...
        var result = OVRSP_1_97_0.ovrp_RetrieveSpaceDiscoveryResults(requestId, ref info);
    ...
    public static unsafe Result SaveSpaces(ulong* spaces, int count, out ulong requestId)
    {
        ...
        return Result.Failure_Unsupported;
#else
        return version < OVRSP_1_97_0.version
            ? Result.Failure_NotYetImplemented
            : OVRSP_1_97_0.ovrp_SaveSpaces((uint)count, spaces, out requestId);
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
        ...
        out UInt64 requestId)
    {
        ...
        return version < OVRSP_1_97_0.version
            ? Result.Failure_NotYetImplemented
            : OVRSP_1_97_0.ovrp_EraseSpaces(spaceCount, spaces, uuidCount, uuids, out requestId);
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
    ...
    public static Result RequestBoundaryVisibility(BoundaryVisibility boundaryVisibility)
    {
        ...
        return Result.Failure_Unsupported;
#else
        return version < OVRSP_1_98_0.version
            ? Result.Failure_NotYetImplemented
            : OVRSP_1_98_0.ovrp_RequestBoundaryVisibility(boundaryVisibility);
#endif
    }
    ...
    public static Result GetBoundaryVisibility(out BoundaryVisibility boundaryVisibility)
    {
        ...
        return version < OVRSP_1_98_0.version
            ? Result.Failure_NotYetImplemented
            : OVRSP_1_98_0.ovrp_GetBoundaryVisibility(out boundaryVisibility);
#endif
    }
    ...
    public static Result CreateDynamicObjectTracker(out ulong tracker)
    {
        ...
        return Result.Failure_Unsupported;
#else
        return version >= OVRSP_1_104_0.version
            ? OVRSP_1_104_0.ovrp_CreateDynamicObjectTracker(out tracker)
            : Result.Failure_Unsupported;
#endif
    }

    public static OVRSTask<OVRSResult<ulong, Result>> CreateDynamicObjectTrackerAsync()
    {
        // The task id and type must match OVRSManager's case OVRSPlugin.EventType.CreateDynamicObjectTrackerResult
        return OVRSTask
...
#else
        return version >= OVRSP_1_104_0.version
            ? OVRSP_1_104_0.ovrp_DestroyDynamicObjectTracker(tracker)
            : Result.Failure_Unsupported;
#endif
    }
    ...
    public static unsafe Result SetDynamicObjectTrackedClasses(ulong tracker, ReadOnlySpan<DynamicObjectClass> classes)
    {
        ...
        return Result.Failure_Unsupported;
#else
        if (version < OVRSP_1_104_0.version) return Result.Failure_Unsupported;

        fixed (DynamicObjectClass* ptr = classes)
        {
            return OVRSP_1_104_0.ovrp_SetDynamicObjectTrackedClasses(tracker, new()
            {
                Classes = ptr,
    ...
    public static OVRSTask<OVRSResult<Result>> SetDynamicObjectTrackedClassesAsync(ulong tracker,
        ReadOnlySpan<DynamicObjectClass> classes)
    {
        // The task id and type must match OVRSManager's case OVRSPlugin.EventType.SetDynamicObjectTrackedClassesResult
        return OVRSTask
...
#else
        return version >= OVRSP_1_104_0.version
            ? OVRSP_1_104_0.ovrp_GetSpaceDynamicObjectData(ref space, out data)
            : Result.Failure_Unsupported;
#endif
    }
    ...
    public static Result GetDynamicObjectTrackerSupported(out bool value)
    {
        ...
        var result = OVRSP_1_104_0.ovrp_GetDynamicObjectTrackerSupported(out var supported);
    ...
    public static Result GetDynamicObjectKeyboardSupported(out bool value)
    {
        ...
        var result = OVRSP_1_104_0.ovrp_GetDynamicObjectKeyboardSupported(out var supported);
        value = supported == Bool.True;
        return result;
#endif
    }
    ...
    public class UnityOpenXR
    {
        ...
        public static void SetClientVersion()
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_SetClientVersion(wrapperVersion.Major, wrapperVersion.Minor,
        ...
        public static IntPtr HookGetInstanceProcAddr(IntPtr func)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                return OVRSP_1_71_0.ovrp_UnityOpenXR_HookGetInstanceProcAddr(func);
            }
            else
            {
                return func;
        ...
        public static bool OnInstanceCreate(UInt64 xrInstance)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                Result result = OVRSP_1_71_0.ovrp_UnityOpenXR_OnInstanceCreate(xrInstance);
                return result == Result.Success;
            }
            else
            {
        ...
        public static void OnInstanceDestroy(UInt64 xrInstance)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnInstanceDestroy(xrInstance);
            }
#endif
        }
        ...
        public static void OnSessionCreate(UInt64 xrSession)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnSessionCreate(xrSession);
            }
#endif
        }
        ...
        public static void OnAppSpaceChange(UInt64 xrSpace)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnAppSpaceChange(xrSpace);
            }
#endif
        }
        ...
        public static void OnSessionStateChange(int oldState, int newState)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnSessionStateChange(oldState, newState);
            }
#endif
        }
        ...
        public static void OnSessionBegin(UInt64 xrSession)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnSessionBegin(xrSession);
            }
#endif
        }
        ...
        public static void OnSessionEnd(UInt64 xrSession)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnSessionEnd(xrSession);
            }
#endif
        }
        ...
        public static void OnSessionExiting(UInt64 xrSession)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnSessionExiting(xrSession);
            }
#endif
        }
        ...
        public static void OnSessionDestroy(UInt64 xrSession)
        {
            ...
            if (version >= OVRSP_1_71_0.version)
            {
                OVRSP_1_71_0.ovrp_UnityOpenXR_OnSessionDestroy(xrSession);
            }
#endif
        }
    }
    ...
    public static void OnEditorShutdown()
    {
        ...
        OVRSP_1_85_0.ovrp_OnEditorShutdown();
#endif
    }
    ...
    internal static Result GetPassthroughPreferences(out PassthroughPreferences preferences)
    {
        ...
        return Result.Failure_Unsupported;
#else
        if (version < OVRSP_1_87_0.version) return Result.Failure_NotYetImplemented;
        return OVRSP_1_87_0.ovrp_GetPassthroughPreferences(out preferences);
#endif // OVRSPLUGIN_UNSUPPORTED_PLATFORM
    }
    ...
    public static bool SetEyeBufferSharpenType(LayerSharpenType sharpenType)
    {
        ...
        if (version >= OVRSP_1_87_0.version)
        {
            return OVRSP_1_87_0.ovrp_SetEyeBufferSharpenType(sharpenType) == Result.Success;
        }
        else
        {
            return false;
    ...
    public static Result PollFuture(ulong future, out FutureState state)
    {
        ...
        return Result.Failure_Unsupported;
#else
        return version >= OVRSP_1_103_0.version
            ? OVRSP_1_103_0.ovrp_PollFuture(future, out state)
            : Result.Failure_NotYetImplemented;
#endif
    }
...
#else
        return version >= OVRSP_1_103_0.version
            ? OVRSP_1_103_0.ovrp_CancelFuture(future)
            : Result.Failure_NotYetImplemented;
#endif
    }
    ...
    public static Result SetExternalLayerDynresEnabled(Bool enabled)
    {
        ...
        return Result.Failure_Unsupported;
#else
        if (version < OVRSP_1_104_0.version) return Result.Failure_NotYetImplemented;

        return OVRSP_1_104_0.ovrp_SetExternalLayerDynresEnabled(enabled);
#endif
    }
    ...
    public static Result SetDeveloperTelemetryConsent(Bool consent)
    {
        ...
        return OVRSP_1_95_0.ovrp_SetDeveloperTelemetryConsent(consent);
#endif
    }
    ...
    public static Result SendMicrogestureHint()
    {
        ...
        OVRSP_1_106_0.ovrp_SendMicrogestureHint();
    ...
    public static class Qpl
    {
        ...
        public readonly unsafe struct Annotation
        {
            ...
            public struct Builder : IDisposable
            {
                ...
                {
                    _entries = OVRSObjectPool.List<Entry>(),
                    _ownedStrings = OVRSObjectPool.List<IntPtr>(),
                };
                ...
                public void Dispose()
                {
                    if (_ownedStrings != null)
                    {
                        ...
                        OVRSObjectPool.Return(_ownedStrings);
                        _ownedStrings = null;
                    }

                    if (_entries != null)
                    {
                        OVRSObjectPool.Return(_entries);
                        _entries = null;
                    }
                }
            }
        ...
        {
#if OVRSPLUGIN_QPL_UNSUPPORTED_PLATFORM
            return;
#else
            if (version < OVRSP_1_92_0.version) return;
            OVRSP_1_92_0.ovrp_QplSetConsent(consent);
#endif
        }
            ...
            long timestampMs = AutoSetTimestampMs)
        {
            ...
            return;
#else
            if (version < OVRSP_1_84_0.version) return;
            OVRSP_1_84_0.ovrp_QplMarkerStart(markerId, instanceKey, timestampMs);
#endif
        }
            ...
            long timestampMs = AutoSetTimestampMs)
        {
            ...
            return;
#else
            if (version < OVRSP_1_105_0.version) return;
            OVRSP_1_105_0.ovrp_QplMarkerStartForJoin(markerId, joinId, cancelMarkerIfAppBackgrounded, instanceKey, timestampMs);
#endif
        }
...
#else
            if (version < OVRSP_1_84_0.version) return;
            OVRSP_1_84_0.ovrp_QplMarkerEnd(markerId, resultTypeId, instanceKey, timestampMs);
#endif
        }
        ...
        public static Result MarkerPoint(int markerId, string name, int instanceKey, long timestampMs)
        {
            ...
            return Result.Failure_Unsupported;
#else
            return version < OVRSP_1_84_0.version
                ? Result.Failure_NotYetImplemented
                : OVRSP_1_84_0.ovrp_QplMarkerPoint(markerId, name, instanceKey, timestampMs);
#endif
        }
            ...
            int instanceKey, long timestampMs)
        {
            ...
            return Result.Failure_Unsupported;
#else
            return version < OVRSP_1_96_0.version
                ? Result.Failure_NotYetImplemented
                : OVRSP_1_96_0.ovrp_QplMarkerPointData(markerId, name, annotations, annotationCount, instanceKey, timestampMs);
#endif
        }
...
#else
            if (version < OVRSP_1_84_0.version) return;
            OVRSP_1_84_0.ovrp_QplMarkerPointCached(markerId, nameHandle, instanceKey, timestampMs);
#endif
        }
...
#else
            if (version < OVRSP_1_84_0.version) return;
            OVRSP_1_84_0.ovrp_QplMarkerAnnotation(markerId, annotationKey, annotationValue,
                instanceKey);
#endif
        }
            ...
            int instanceKey)
        {
            ...
            return version < OVRSP_1_96_0.version
                ? Result.Failure_NotYetImplemented
                : OVRSP_1_96_0.ovrp_QplMarkerAnnotationVariant(markerId, annotationKey, in annotationValue, instanceKey);
#endif
        }
        ...
        public static bool CreateMarkerHandle(string name, out int nameHandle)
        {
            ...
            return OVRSP_1_84_0.ovrp_QplCreateMarkerHandle(name, out nameHandle) == Result.Success;
#endif
        }
        ...
        public static bool DestroyMarkerHandle(int nameHandle)
        {
            ...
            return false;
#else
            if (version < OVRSP_1_84_0.version) return false;
            return OVRSP_1_84_0.ovrp_QplDestroyMarkerHandle(nameHandle) == Result.Success;
#endif
        }
    }
    ...
    public static class UnifiedConsent
    {
        ...
        public static Result SaveUnifiedConsent(bool consentValue)
        {
            ...
            return Result.Failure_Unsupported;
#else
            if (version < OVRSP_1_106_0.version) return Result.Failure_Unsupported;

            return OVRSP_1_106_0.ovrp_SaveUnifiedConsent(ToolId, consentValue ? Bool.True : Bool.False);
#endif
        }
        ...
        public static Result SaveUnifiedConsentWithOlderVersion(bool consentValue, int consentVersion)
        {
            ...
            return OVRSP_1_106_0.ovrp_SaveUnifiedConsentWithOlderVersion(ToolId, consentValue ? Bool.True : Bool.False, consentVersion);
#endif
        }
        ...
        public static bool? GetUnifiedConsent()
        {
            ...
            return false;
#else
            if (version < OVRSP_1_106_0.version) return false;

            return OVRSP_1_106_0.ovrp_GetUnifiedConsent(ToolId) switch
            {
        ...
        public static string GetConsentTitle()
        {
            ...
            return "";
#else
            if (version < OVRSP_1_106_0.version) return "";

            IntPtr textPtr = Marshal.AllocHGlobal(sizeof(byte) * OVRSP_1_106_0.OVRSP_CONSENT_TITLE_MAX_LENGTH);
            Result result = OVRSP_1_106_0.ovrp_GetConsentTitle(textPtr);
        ...
        public static string GetConsentMarkdownText()
        {
            ...
            IntPtr textPtr = Marshal.AllocHGlobal(sizeof(byte) * OVRSP_1_106_0.OVRSP_CONSENT_TEXT_MAX_LENGTH);
            Result result = OVRSP_1_106_0.ovrp_GetConsentMarkdownText(textPtr);
        ...
        public static string GetConsentNotificationMarkdownText()
        {
            ...
            IntPtr textPtr = Marshal.AllocHGlobal(sizeof(byte) * OVRSP_1_106_0.OVRSP_CONSENT_NOTIFICATION_MAX_LENGTH);
            string settingsPath = "Edit > Preferences > Meta XR";
            IntPtr settingsPathPtr = Marshal.StringToHGlobalAnsi(settingsPath);
            Result result = OVRSP_1_106_0.ovrp_GetConsentNotificationMarkdownText(settingsPathPtr, textPtr);
        ...
        public static string GetConsentSettingsChangeText()
        {
            ...
            IntPtr textPtr = Marshal.AllocHGlobal(sizeof(byte) * OVRSP_1_106_0.OVRSP_CONSENT_SETTINGS_CHANGE_MAX_LENGTH);
            Result result = OVRSP_1_106_0.ovrp_GetConsentSettingsChangeText(textPtr);
        ...
        public static bool ShouldShowTelemetryConsentWindow()
        {
            ...
            return OVRSP_1_106_0.ovrp_ShouldShowTelemetryConsentWindow(ToolId) == Bool.True;
#endif
        }
        ...
        public static bool IsConsentSettingsChangeEnabled()
        {
            ...
            return true;
#else
            if (version < OVRSP_1_106_0.version) return true;

            return OVRSP_1_106_0.ovrp_IsConsentSettingsChangeEnabled(ToolId) == Bool.True;
#endif
        }
        ...
        public static bool ShouldShowTelemetryNotification()
        {
            ...
            return OVRSP_1_106_0.ovrp_ShouldShowTelemetryNotification(ToolId) == Bool.True;
#endif
        }
        ...
        public static Result SetNotificationShown()
        {
            ...
            return OVRSP_1_106_0.ovrp_SetNotificationShown(ToolId);
#endif
        }
    }

    private const string pluginName = "OVRSPlugin";
    ...
    private static class OVRSP_0_1_0
    {
    ...
    private static class OVRSP_0_1_1
    {
    ...
    private static class OVRSP_0_1_2
    {
    ...
    private static class OVRSP_0_1_3
    {
    ...
    private static class OVRSP_1_1_0
    {
        ...
        public static string ovrp_GetVersion() { return Marshal.PtrToStringAnsi(OVRSP_1_1_0._ovrp_GetVersion()); }
        ...
        public static string ovrp_GetNativeSDKVersion() { return Marshal.PtrToStringAnsi(OVRSP_1_1_0._ovrp_GetNativeSDKVersion()); }
        ...
        public static string ovrp_GetSystemProductName() { return Marshal.PtrToStringAnsi(OVRSP_1_1_0._ovrp_GetSystemProductName()); }
        ...
        public static string ovrp_GetAppLatencyTimings() { return Marshal.PtrToStringAnsi(OVRSP_1_1_0._ovrp_GetAppLatencyTimings()); }
    ...
    private static class OVRSP_1_2_0
    {
    ...
    private static class OVRSP_1_3_0
    {
    ...
    private static class OVRSP_1_5_0
    {
    ...
    private static class OVRSP_1_6_0
    {
    ...
    private static class OVRSP_1_7_0
    {
    ...
    private static class OVRSP_1_8_0
    {
    ...
    private static class OVRSP_1_9_0
    {
    ...
    private static class OVRSP_1_12_0
    {
    ...
    private static class OVRSP_1_15_0
    {
        public static readonly System.Version version = new System.Version(1, 15, 0);

        public const int OVRSP_EXTERNAL_CAMERA_NAME_SIZE = 32;
        ...
        public static extern Result ovrp_GetExternalCameraName(int cameraId,
            [MarshalAs(UnmanagedType.LPArray, SizeConst = OVRSP_EXTERNAL_CAMERA_NAME_SIZE)]
            char[] cameraName);
    ...
    private static class OVRSP_1_16_0
    {
    ...
    private static class OVRSP_1_17_0
    {
        public static readonly System.Version version = new System.Version(1, 17, 0);

#if UNITY_EDITOR_WIN || UNITY_EDITOR_OSX || UNITY_STANDALONE_WIN || OVRSPLUGIN_EDITOR_MOCK_ENABLED
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
    ...
    private static class OVRSP_1_18_0
    {
    ...
    private static class OVRSP_1_28_0
    {
    ...
    private static class OVRSP_1_29_0
    {
    ...
    private static class OVRSP_1_30_0
    {
    ...
    private static class OVRSP_1_31_0
    {
    ...
    private static class OVRSP_1_32_0
    {
    ...
    private static class OVRSP_1_34_0
    {
    ...
    private static class OVRSP_1_45_0
    {
    ...
    private static class OVRSP_1_46_0
    {
    ...
    private static class OVRSP_1_49_0
    {
        public static readonly System.Version version = new System.Version(1, 49, 0);

        public const int OVRSP_ANCHOR_NAME_SIZE = 32;
        ...
        public static extern Result ovrp_Media_GetCameraAnchorName(IntPtr anchorHandle,
            [MarshalAs(UnmanagedType.LPArray, SizeConst = OVRSP_ANCHOR_NAME_SIZE)]
            char[] cameraName);
    ...
    private static class OVRSP_1_55_0
    {
    ...
    private static class OVRSP_1_55_1
    {
...
#endif // !(OVRSPLUGIN_UNSUPPORTED_PLATFORM && OVRSPLUGIN_QPL_UNSUPPORTED_PLATFORM)

    private static class OVRSP_1_64_0
    {
    ...
    private static class OVRSP_1_65_0
    {
    ...
    private static class OVRSP_1_66_0
    {
    ...
    private static class OVRSP_1_67_0
    {
        public static readonly System.Version version = new System.Version(1, 67, 0);
    }

    private static class OVRSP_1_68_0
    {
        public static readonly System.Version version = new System.Version(1, 68, 0);

        public const int OVRSP_RENDER_MODEL_MAX_PATH_LENGTH = 256;
        public const int OVRSP_RENDER_MODEL_MAX_NAME_LENGTH = 64;
    ...
    private static class OVRSP_1_69_0
    {
    ...
    private static class OVRSP_1_70_0
    {
    ...
    private static class OVRSP_1_71_0
    {
    ...
    private static class OVRSP_1_72_0
    {
    ...
    private static class OVRSP_1_78_0
    {
    ...
    private static class OVRSP_1_79_0
    {
    ...
    private static class OVRSP_1_83_0
    {
    ...
    private static class OVRSP_1_84_0
    {
    ...
    private static class OVRSP_1_85_0
    {
    ...
    private static class OVRSP_1_86_0
    {
    ...
    private static class OVRSP_1_87_0
    {
    ...
    private static class OVRSP_1_88_0
    {
    ...
    private static class OVRSP_1_93_0
    {
    ...
    private static class OVRSP_1_96_0
    {
    ...
    private static class OVRSP_1_97_0
    {
    ...
    private static class OVRSP_1_98_0
    {
    ...
    private static class OVRSP_1_99_0
    {
    ...
    private static class OVRSP_1_100_0
    {
    ...
    private static class OVRSP_1_104_0
    {
    ...
    private static class OVRSP_1_105_0
    {
    ...
    private static class OVRSP_1_106_0
    {
        public const int OVRSP_CONSENT_TITLE_MAX_LENGTH = 256;
        public const int OVRSP_CONSENT_TEXT_MAX_LENGTH = 2048;
        public const int OVRSP_CONSENT_NOTIFICATION_MAX_LENGTH = 1024;

        public const int OVRSP_CONSENT_SETTINGS_CHANGE_MAX_LENGTH = 1024;
